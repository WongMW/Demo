...
Public Class AptifySitefinityIntegration
    ...
    ''' <remarks></remarks>
    <WebMethod()> _
    Public Function NumberOfUsers() As Integer
        Try
    ...
    ''' <remarks></remarks>
    <WebMethod()> _
    Public Function GetTopicCodeInfo() As String()()
        Try
    ...
    ''' <remarks></remarks>
    <WebMethod()> _
    Public Function CreateUser(ByVal sUserName As String, ByVal sPWD As String, ByVal sEmail As String) As String
        Try
    ...
    ''' <remarks></remarks>
    <WebMethod()> _
    Public Function CreateNewUser(ByVal sUserName As String, ByVal FirstName As String, ByVal LastName As String, ByVal sPWD As String, ByVal sEmail As String) As String
        Try
    ...
    ''' <remarks></remarks>
    <WebMethod()> _
    Public Function UserNameExists(ByVal sUserName As String) As Boolean
        Try
            Dim oMemUser As MembershipUser
            Dim oManager As Telerik.Sitefinity.Security.UserManager = Telerik.Sitefinity.Security.UserManager.GetManager
    ...
    ''' <remarks></remarks>
    <WebMethod()> _
    Public Function AddUserToGroup(ByVal sCMSUserName As String, ByVal sGroupName As String) As Boolean
    ...
    ''' <remarks></remarks>
    <WebMethod()> _
    Public Function GetSiteFinityUserIDFromUserName(ByVal sUserName As String) As String
        Try
    ...
    ''' <remarks></remarks>
    <WebMethod()> _
    Public Function LoginSitefinityUser(ByVal UserName As String, ByVal Password As String) As Int32
        Return 2
    End Function
    ...
    ''' <remarks></remarks>
    <WebMethod()> _
    Public Function SynchUserGroups(ByVal CMSUserName As String, ByVal UserGroups As String) As Boolean
