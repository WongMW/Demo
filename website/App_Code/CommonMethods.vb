    ...
    Public Class CommonMethods
        ...
        Public Shared Function EmailAddressCheck(ByVal emailAddress As String) As Boolean
            Try
                ...
                Next
                'end logic 
                 ' updated below string by Govind Mande by 12 May 2016
                'Dim pattern As String = "[a-zA-Z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-zA-Z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-zA-Z0-9](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?\.)+(?:[A-Z]{2}|com|COM|org|ORG|net|NET|edu|EDU|gov|GOV|mil|MIL|biz|BIZ|info|INFO|mobi|MOBI|name|NAME|aero|AERO|asia|ASIA|jobs|JOBS|museum|MUSEUM|in|IN|co|CO|uk|UK|ie|IE)\b"
                'Upddated below string by Jim on 2016-05-13 
                 Dim pattern As String = "[a-zA-Z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-zA-Z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-zA-Z0-9](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?\.)+(?:[A-Z]{2}|com|COM|org|ORG|net|NET|edu|EDU|gov|GOV|int|INT|mil|MIL|biz|BIZ|info|INFO|mobi|MOBI|name|NAME|aero|AERO|asia|ASIA|jobs|JOBS|museum|MUSEUM|in|IN|ie|IE|co|CO|uk|UK|ru|RU|kz|KZ|tr|TR|ua|UA|fr|FR|es|ES|se|SE|no|NO|de|DE|fi|FI|pl|PL|it|IT|ro|RO|by|BY|gr|GR|bg|BG|is|IS|hu|HU|pt|PT|rs|RS|az|AZ|at|AT|cz|CZ|ge|GE|lt|LT|lv|LV|hr|HR|ba|BA|sk|SK|ee|EE|dk|DK|ch|CH|nl|NL|md|MD|be|BE|am|AM|al|AL|mk|MK|si|SI|me|ME|cy|CYlu|LU|ad|AD|mt|MT|li|LI|sm|SM|mc|MC|va|VA|au|AU|sg|SG|hk|HK|us|US|gb|GB|eu|EU|cn|CN)\b"
