...
Namespace Aptify.Framework.Web.eBusiness.Generated
    ...
    Partial Class CasesClass
        ...
        Public Property RedirectURLs() As String
            Get
                If ViewState.Item("RedirectURL") IsNot Nothing Then
                    Return ViewState.Item("RedirectURL").ToString()
                Else
                    Return ""
                End If
            ...
            Set(ByVal value As String)
                ViewState.Item("RedirectURL") = Me.FixLinkForVirtualPath(value)
            End Set
        End Property
