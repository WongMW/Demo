...
<div class="sfNavWrp sfNavTreeviewWrp nav-sidebar <%= this.GetCssClass() %>">
    ...
    <ul class="sfNavTreeview sfNavList" runat="server" id="navigationUl">
      <li>
      <a runat="server" href="#">
        <%= ((Telerik.Sitefinity.Web.UI.NavigationControls.LightNavigationControl)(((System.Web.UI.Control)this).BindingContainer.BindingContainer)).SelectedPageTitle %>
        </a>
       </li>
