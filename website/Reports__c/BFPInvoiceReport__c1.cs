...
namespace SitefinityWebApp.Reports__c {
    ...
    public class BFPInvoiceReport__c : ReportClass {
        
        public BFPInvoiceReport__c() {
        }
        
        public override string ResourceName {
            get {
                return "BFPInvoiceReport__c.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SitefinityWebApp.Reports__c.BFPInvoiceReport__c.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedBFPInvoiceReport__c : Component, ICachedReport {
        
        public CachedBFPInvoiceReport__c() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            BFPInvoiceReport__c rpt = new BFPInvoiceReport__c();
            rpt.Site = this.Site;
            return rpt;
        }
