...
#End Region
        ...
        Private Sub LoadGrid()
            ...
            Try
                ...
                If ViewState(ATTRIBUTE_DATATABLE_ABSTRACT) IsNot Nothing Then
                    grdMain.DataSource = ViewState(ATTRIBUTE_DATATABLE_ABSTRACT)
                Else
                    ...
                    If sID Is Nothing Then
                        ...
                        'ParentID currently does not exist in the core version 4.0 Abstracts entity definition. 
                        'The following code exists as a sample that can be implemented if a ParentID field is added to Abstracts.
                        'ElseIf IsNumeric(sID) Then
                        '    sSQL = "SELECT ID,Subject,Title,SubmittedBy,DateSubmitted,Category FROM " & _
                        '           sDatabase & _
                        '           "..vwAbstracts WHERE ParentID=" & _
                        '           sID & " ORDER BY DateSubmitted,SubmittedBy"
                        'Else
                    ...
                    If Not dt Is Nothing AndAlso dt.Rows.Count > 0 Then
                        'Dim hlink As Telerik.Web.UI.GridHyperLinkColumn
                        'hlink = CType(grdMain.MasterTableView.Columns.Item(0), Telerik.Web.UI.GridHyperLinkColumn)
        ...
        Protected Sub grdMain_PageIndexChanging(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridPageChangedEventArgs) Handles grdMain.PageIndexChanged
            LoadGrid()
        End Sub
        Protected Sub grdMain_PageIndexChanging(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridPageSizeChangedEventArgs) Handles grdMain.PageSizeChanged
            LoadGrid()
        End Sub
