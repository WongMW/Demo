<%@ Control Language="VB" AutoEventWireup="false" Inherits="Aptify.Framework.Web.eBusiness.AbstractManagement.ReviewSingleAbstract" CodeFile="ReviewSingleAbstract.ascx.vb" %>
