<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ChapterManagementControl.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.Chapters.ChapterManagementControl" %>
