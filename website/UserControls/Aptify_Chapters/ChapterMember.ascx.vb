        ...
        Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
            ...
            Try
                ...
                If oGE.Save(False) Then
                    ...
                    'Suraj Issue 16145 , 5/9/13 , replace Application variabe object instead of Session  variabe object
                    'as well as  we replace the Session("ReturnToPageURL") to Session("ReturnToPage") because we are using the "Session("ReturnToPage")" to get the privious page url
