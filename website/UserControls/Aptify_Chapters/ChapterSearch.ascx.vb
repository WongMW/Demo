        ...
        Protected Sub LoadResults()
            ...
            Try
                ...
                If Len(sName) > 0 Or lCompanyType > 0 Then
                    ...
                    'Dim hlink As Telerik.Web.UI.GridHyperLinkColumn = CType(grdResults.Columns(0), Telerik.Web.UI.GridHyperLinkColumn)


                    'Dim tempURL As String = Me.RedirectURL & "?" & Me.RedirectIDParameterName & "={0}"
                    ...
                    'hlink.DataNavigateUrlFormatString = navigate

                    'DirectCast(grdResults.Columns(0), HyperLinkColumn).DataNavigateUrlFormatString = Me.RedirectURL & "?" & Me.RedirectIDParameterName & "={0}"
