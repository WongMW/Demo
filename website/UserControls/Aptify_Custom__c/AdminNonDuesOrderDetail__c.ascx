<%@ Control Language="VB" AutoEventWireup="false" CodeFile="AdminNonDuesOrderDetail__c.ascx.vb"  Debug="true" 
...
<%@ Register TagPrefix="uc1" TagName="CreditCard" Src="~/UserControls/Aptify_Custom__c/NonDuesFirmbillingPaymentControl__c.ascx" %>
<div class="maindiv">
                            ...
                            <MasterTableView>
                                <Columns>
                                    ...
                                    <rad:GridTemplateColumn >
                                        ...
                                        <HeaderTemplate>
                                            <asp:CheckBox ID="chkAllMakePayment" runat="server" OnCheckedChanged="ToggleSelectedState" AutoPostBack="True" />
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:CheckBox Enabled="true" runat="server" ID="chkMakePayment" OnCheckedChanged="chkMakePayment_CheckedChanged" 
