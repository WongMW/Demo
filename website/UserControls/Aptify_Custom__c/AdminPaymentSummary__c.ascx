...
<%@ Control Language="VB" AutoEventWireup="false" CodeFile="AdminPaymentSummary__c.ascx.vb"
...
<span id="spnNote" runat="server" visible="false"><asp:Label ID="lblNote" runat="server" Text="Please Take Print if you choose Bill Me Later."></asp:Label></span>
 </ContentTemplate>
</asp:UpdatePanel>
<table>
    <tr>
