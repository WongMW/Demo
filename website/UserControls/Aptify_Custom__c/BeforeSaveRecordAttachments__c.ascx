...
<%@ Control Language="VB" AutoEventWireup="false" CodeFile="BeforeSaveRecordAttachments__c.ascx.vb"
    ...
    <tr runat="server" id="trAdd" visible="false">
        <td>
            <table>
                <tr>
                    ...
                    <td>
                        ...
                        <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please upload file"
                            ...
                            <%--Below code commented by GM for Redmine #20181 --%>
                       <%-- <asp:CustomValidator ID="cvUpload" runat="server" ControlToValidate="FileUpload1"
                            ...
                            OnServerValidate="FileUpload1_Validate" ValidationGroup="AGV" ForeColor="Red"></asp:CustomValidator>--%>
                            <%--End Redmine #20181 --%>
                             <%-- Susan Wong, #18954 Improve UI --%>
                    </td>
                ...
                <%--<tr><td>Description</td><td><asp:TextBox ID="txtDescription" runat="server"/></td></tr>--%>
                <tr>
                    <%-- Susan Wong, #18954 Improve UI --%>
                    <td>
                        <asp:Button CssClass="submitBtn" runat="server" ID="btnAdd" Text="Upload"  ValidationGroup="AGV"/>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <asp:UpdatePanel ID="UppanelGrid" runat="server">
                <contenttemplate>
                    <div class="upload-grid">
                        <asp:GridView ID="grdAttachments" runat="server" AutoGenerateColumns="false" ><%-- Susan Wong, #18954 Improve UI --%>
                            <Columns>
                              ...
                              <asp:BoundField DataField="Name" ItemStyle-Wrap="true" HeaderText="File" />
                                ...
                                <asp:BoundField DataField="DateUpdated" HeaderText="Date" DataFormatString="{0:d}"  ControlStyle-Width="50px" />
