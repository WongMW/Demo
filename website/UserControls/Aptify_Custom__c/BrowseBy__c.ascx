<%@ Control Language="vb" AutoEventWireup="false" Inherits="Aptify.Framework.Web.eBusiness.Directories.BrowseByControl__c" CodeFile="BrowseBy__c.ascx.vb" debug= "true" %>
<%@ Register Src="PersonDirectoryGrid__c.ascx" TagName="PersonDirectoryGrid" TagPrefix="uc2" %>
