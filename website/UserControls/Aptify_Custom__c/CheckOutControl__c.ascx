<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CheckoutControl__c.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.ProductCatalog.CheckoutControl__c" %>
<%@ Register TagPrefix="uc1" TagName="CartGrid" Src="~/UserControls/Aptify_Custom__c/CartGrid__c.ascx" %>
