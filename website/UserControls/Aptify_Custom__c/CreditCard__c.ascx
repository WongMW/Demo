<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CreditCard__c.ascx.vb"
        ...
        <div style="width=90%; float: bottom">
            <table id="Table1" runat="server" class="data-form">
                <tr>
                    ...
                    <td align="right" runat="server" id="tdReceiptlbl" visible="false">
                        <asp:Label ID="lblReceipt" Text="Receipt No :" ForeColor="#333333" Font-Size="13px"
                            Font-Bold="true" runat="server"></asp:Label>
                    </td>
                    <td class="Paddingrightpayment" align="left" runat="server" id="tdReceiptNo" visible="false">
            ...
            <table id="tblMain" runat="server" class="data-form">
                ...
                <tr runat="server" id="PaymentTypeSelection">
                    ...
                    <td class="tblCreditCartSetPadding">
                        ...
                        <%--Kavita Zinage, Issue #13429, 14/05/2016--%>
                          <table cellpadding="0px" cellspacing="0px">
                            <tr>
                                <td align="left">
                                    <%--<rad:RadBinaryImage ID="ImgLaser" runat="server" AutoAdjustImageControlSize="false"
                                        CssClass="creditcardImg" />--%>
                                ...
                                <td>
                                     <asp:Label ID="lbl1" runat="server" Text="accepted cards"></asp:Label>
                                </td>
                                <%--<td>
                                    <rad:RadBinaryImage ID="ImgDelta" runat="server" CssClass="creditcardImg" AutoAdjustImageControlSize="false" Visible="false">
                                    </rad:RadBinaryImage>
                                </td>
                                <td>
                                    <rad:RadBinaryImage ID="ImgDiner" runat="server" CssClass="creditcardImg" AutoAdjustImageControlSize="false" Visible="false">
                                    </rad:RadBinaryImage>
                                </td>--%>
                                <tr>
                                    <td align="left">
                                        
                                        <rad:RadBinaryImage ID="ImgVisaDebit" runat="server" AutoAdjustImageControlSize="false"
                                            CssClass="creditcardImg" />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <%-- <td>
                                        <rad:RadBinaryImage ID="ImgJcb" runat="server" CssClass="creditcardImg" AutoAdjustImageControlSize="false" Visible="false">
                                        </rad:RadBinaryImage>
                                    </td>--%>
                                </tr>
                                <tr>
...
<%--END By Kavita Zinage, Issue #13429, 14/05/2016--%>
                ...
                <tr id="trCardNum" runat="server">
                   ...
                   <%-- for redmine 17373--%>
                         <%--  <asp:TextBox ID="txtCCNumber" runat="server" AutoComplete="Off" AutoPostBack="true"
                          ...
                          <asp:TextBox ID="txtCCNumber" runat="server" AutoComplete="Off" AutoPostBack="true"
                            OnTextChanged="txtCCNumber_TextChanged" EnableViewState="False" Width="335px"></asp:TextBox>
                ...
                <tr id="trExpiryDate" runat="server">
                    ...
                    <td>
                        <asp:DropDownList ID="dropdownMonth" runat="server" Width="125px">
            ...
            <table id="tblPONum" runat="server" class="data-form">
                <%--Sandeep issue#14671 20/02/2013--%>
