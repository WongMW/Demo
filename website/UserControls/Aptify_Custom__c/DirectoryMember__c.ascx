<%@ Control Language="VB" AutoEventWireup="false" CodeFile="DirectoryMember__c.ascx.vb"
            ...
            <table id="tblmember" runat="server" width="100%" class="data-form">
                <tr>
                    <td colspan="2">
                        ...
                        <asp:LinkButton ID="lnkAddPerson" runat="server">Add Persons</asp:LinkButton>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <rad:RadGrid ID="grdmember" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                            ...
                            CellSpacing="0" GridLines="None" OnItemCreated="grdmember_GridItemCreated">
                            ...
                            <MasterTableView AllowFilteringByColumn="true" AllowSorting="true">
                                ...
                                <Columns>
                                    ...
                                    <rad:GridBoundColumn HeaderText="ID" DataField="ID" Visible="False" ItemStyle-CssClass="IdWidth "
                                        FilterControlWidth="70px" CurrentFilterFunction="EqualTo" ShowFilterIcon="false"
                                        SortExpression="ID" HeaderStyle-Width="10%" AutoPostBackOnFilter="true" UniqueName="ID">
                                    ...
                                    <rad:GridTemplateColumn HeaderText="Member" DataField="FirstLast" SortExpression="FirstLast"
                                        ...
                                        <ItemStyle HorizontalAlign="Center" CssClass="LeftAlign tdVerticalAlignMiddle" Width="15%">
                                        </ItemStyle>
                                        <ItemTemplate>
                                    ...
                                    <rad:GridTemplateColumn HeaderText="Email" DataField="Email" SortExpression="Email"
                                        ...
                                        <ItemStyle HorizontalAlign="Center" CssClass="LeftAlign Emailstyle tdVerticalAlignMiddle"
                                            Width="10%"></ItemStyle>
                                        <ItemTemplate>
                                    ...
                                    <rad:GridBoundColumn HeaderText="Membership Type" DataField="MemberType" FilterControlWidth="90px"
                                        ItemStyle-CssClass="LeftAlign " SortExpression="MemberType" AutoPostBackOnFilter="true"
                                        ItemStyle-Width="10%" CurrentFilterFunction="Contains" ShowFilterIcon="false"
                                        UniqueName="MemberShipType">
                                    ...
                                    <rad:GridTemplateColumn HeaderText="Status" SortExpression="Status" AutoPostBackOnFilter="true"
                                        ...
                                        DataField="Status">
                                        <ItemStyle HorizontalAlign="Center" CssClass="LeftAlign tdVerticalAlignMiddle" Width="10%">
                                        </ItemStyle>
                                        <ItemTemplate>
                                            <table>
                                                <tr>
                                    ...
                                    <rad:GridTemplateColumn HeaderText="Make Mentor" AllowFiltering="true" AutoPostBackOnFilter="true"
                                        CurrentFilterFunction="Contains" ShowFilterIcon="false" FilterControlWidth="70px"
                                        SortExpression="IsMentor__c" DataField="IsMentor__c">
                                        <ItemStyle HorizontalAlign="Center" CssClass="LeftAlign tdVerticalAlignMiddle" Width="10%">
                                        </ItemStyle>
                                        <ItemTemplate>
                                            <asp:Label ID="lblMakeMentor" HeaderText="Email" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"IsMentor__c") %>'> </asp:Label>
                                        </ItemTemplate>
                                    </rad:GridTemplateColumn>
        ...
        <rad:RadWindow ID="radRCValidation" runat="server" Width="400px" Height="100px" Modal="True"
            ...
            <ContentTemplate>
                <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f4f3f1;
                    ...
                    <tr>
                        <td align="center">
                            <asp:Button ID="btnradRCValidation" runat="server" Text="OK" Width="50px" class="submitBtn"
                                OnClick="btnNo_Click" ValidationGroup="ok" />&nbsp;&nbsp;
                        </td>
                    </tr>
                </table>
            </ContentTemplate>
