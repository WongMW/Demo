<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ExpoRegistration__c.ascx.vb"Inherits="Aptify.Framework.Web.eBusiness.ProductCatalog.ExpoRegistration__c" %>
