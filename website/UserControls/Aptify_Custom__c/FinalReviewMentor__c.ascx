<%@ Control Language="VB" AutoEventWireup="false" CodeFile="FinalReviewMentor__c.ascx.vb"
                    ...
                    <div class="info-data" style="margin: 0 5% 0 6% !important;">
                        <div class="row-div clearfix">
                            <div style="text-align: left;" class="field-div1 w30">
                                <b>Trainee Name:</b> &nbsp;<asp:Label ID="lblStudentName" runat="server" Text=""></asp:Label>
                        ...
                        <div class="row-div clearfix">
                         ...
                         <div class="row-div clearfix">
                            <div style="text-align: left;" class="field-div1 w30">
                                <b>Date of Final Review:</b> &nbsp;<asp:Label ID="lblFinalReviewDate" runat="server" Text=""></asp:Label>
                            </div>
                            <div class="field-div1 w60">
                                &nbsp;
                            </div>
                        ...
                        <div style="text-align: left;" class="row-div clearfix">
                            <div style="text-align: left; font-weight: normal;" class="label-div w30">
                                <div>
                                    <span style="color: Red;">*</span><b>Mentor Evaluation:</b>
                                </div>
                            </div>
