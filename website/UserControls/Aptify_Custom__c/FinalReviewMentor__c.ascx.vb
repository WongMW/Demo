...
'-----------------------------------------------------------------------------------------------------------------------------------------------------
'Govind Mande               09/25/2015                        Final  Review Create Page
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
Namespace Aptify.Framework.Web.eBusiness
    Partial Class FinalReviewMentor__c
...
#Region "Property Setting"
        ...
        Protected Overrides Sub SetProperties()
            ...
            If String.IsNullOrEmpty(FinalReviewSummaryMentorPage) Then
                FinalReviewSummaryMentorPage = Me.GetLinkValueFromXML(ATTRIBUTE_CONTROL_REDIRECTURL_FinalReviewSummaryMentorPage)
            End If
        End Sub
        ...
        Private Sub LoadPersonDetails()
            Try
                ...
                If Not dt Is Nothing AndAlso dt.Rows.Count > 0 Then
                    ...
                    lblFinalReviewDate.Text = Now.Date
                End If
            Catch ex As Exception
                Aptify.Framework.ExceptionManagement.ExceptionManager.Publish(ex)
            End Try
        ...
        Public Function AddStudentDiaryRecord(ByVal Status As String) As Boolean
            Try
                ...
                With oStudentDiaryGE
                    ...
                    If Convert.ToString(ViewState("CallingSubmit")).ToLower.Trim = "yes" Then
                        .SetValue("ReviewDate", Now.Date)
                    End If
...
#Region "ButtonEvent"
        ...
        Protected Sub btnBack_Click(sender As Object, e As System.EventArgs) Handles btnBack.Click
            Try
                ...
                If Aptify.Framework.Web.Common.WebCryptography.Decrypt(Request.QueryString("Page")).ToLower = "sm" Then
                    Response.Redirect(FinalReviewSummaryMentorPage, False)
                ElseIf Aptify.Framework.Web.Common.WebCryptography.Decrypt(Request.QueryString("Page")).ToLower = "md" Then
        ...
        Private Function StudentDairyAlreadySubmitted() As Boolean
            Try
                Dim sSql As String = "..spCheckAlreadyCADairySubmitted__c @StudentID=" & User1.PersonID & ",@Type='Final Review'"
