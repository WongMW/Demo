...
'-----------------------------------------------------------------------------------------------------------------------------------------------------
'Govind Mande               09/24/2015                        Final Review Member
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
Namespace Aptify.Framework.Web.eBusiness
    Partial Class FinalReviewSummaryMentor__c
        ...
        Protected Const ATTRIBUTE_CONTROL_REDIRECTURL_CreateFinalReviewMentorPage As String = "FinalReviewMentor"
        Protected Const ATTRIBUTE_CONTROL_REDIRECTURL_FinalReviewSummaryMentorPage As String = "FinalReviewSummaryMentorPage"
#Region "Property Setting"
        ...
        Public Overridable Property CreateSixMonthlyMentorReviewPage() As String
            Get
                If Not ViewState(ATTRIBUTE_CONTROL_REDIRECTURL_CreateFinalReviewMentorPage) Is Nothing Then
                    Return CStr(ViewState(ATTRIBUTE_CONTROL_REDIRECTURL_CreateFinalReviewMentorPage))
                Else
                    Return String.Empty
                End If
            End Get
            Set(ByVal value As String)
                ViewState(ATTRIBUTE_CONTROL_REDIRECTURL_CreateFinalReviewMentorPage) = Me.FixLinkForVirtualPath(value)
            End Set
        End Property

        Public Overridable Property FinalReviewSummaryMentorPage() As String
            Get
                If Not ViewState(ATTRIBUTE_CONTROL_REDIRECTURL_FinalReviewSummaryMentorPage) Is Nothing Then
                    Return CStr(ViewState(ATTRIBUTE_CONTROL_REDIRECTURL_FinalReviewSummaryMentorPage))
                Else
                    Return String.Empty
                End If
            End Get
            Set(ByVal value As String)
                ViewState(ATTRIBUTE_CONTROL_REDIRECTURL_FinalReviewSummaryMentorPage) = Me.FixLinkForVirtualPath(value)
            End Set
        End Property
        ...
        Protected Overrides Sub SetProperties()
            ...
            If String.IsNullOrEmpty(CreateSixMonthlyMentorReviewPage) Then
                CreateSixMonthlyMentorReviewPage = Me.GetLinkValueFromXML(ATTRIBUTE_CONTROL_REDIRECTURL_CreateFinalReviewMentorPage)
            End If
        End Sub
...
#Region "LoadData"
        ...
        Private Sub LoadPersonDetails()
            Try
                Dim sSql As String = Database & "..spGetPersonFinalReviewSummaryMentor__c @MentorID=" & User1.PersonID
...
#Region "Grid Event"
        ''' <summary>
        ''' Redirect To Create final ewview Page code
        ''' </summary>
