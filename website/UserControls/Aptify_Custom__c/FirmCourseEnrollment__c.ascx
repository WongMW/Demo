<%@ Control Language="VB" AutoEventWireup="false" CodeFile="FirmCourseEnrollment__c.ascx.vb"
                    ...
                    <div class="label-div w25" align="left">
                        <div class="info-data">
                            <div class="row-div clearfix">
                                ...
                                <div class="field-div1 w80" align="left">
                                    <asp:Label ID="lblSubmitTimeTable" runat="server" Text=""></asp:Label>
                    ...
                    <div class="label-div w40" align="left">
                        <div class="info-data">
                            <div class="row-div clearfix">
                                ...
                                <div class="field-div1 w50" align="left">
                                     <asp:LinkButton ID="lnkFAEEnrollment" runat="server">FAE</asp:LinkButton>
                                ...
                                <div style="font-weight: bold;">
                                    Time Table: <b>
                                        <asp:DropDownList ID="ddlTimeTableList" runat="server">
                                         ...
                                         <asp:Label ID="lblTimeTablePopup" runat="server" Text=""></asp:Label>
                                </div>
                                <div>
                                    <div class="row-div clearfix">
