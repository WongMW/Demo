...
Namespace Aptify.Framework.Web.eBusiness.Education
    Partial Class InstructorCenter__c
        ...
        Protected Const ATTRIBUTE_INSTRUCTOR_AUTHORIZED_CALENDAR As String = "InstructorAuthorizedCalendar"
        Protected Const ATTRIBUTE_CONTORL_DEFAULT_NAME As String = "InstructorCenter__c"
...
#Region "InstructorCenter Specific Properties"
        ...
        ''' <summary>
        ''' InstructorCalendar page url
        ''' </summary>
        Public Overridable Property InstructorAuthorizedCalendar As String
            Get
                If Not ViewState(ATTRIBUTE_INSTRUCTOR_AUTHORIZED_CALENDAR) Is Nothing Then
                    Return CStr(ViewState(ATTRIBUTE_INSTRUCTOR_AUTHORIZED_CALENDAR))
                Else
                    Return String.Empty
                End If
            End Get
            Set(ByVal value As String)
                ViewState(ATTRIBUTE_INSTRUCTOR_AUTHORIZED_CALENDAR) = Me.FixLinkForVirtualPath(value)
            End Set
        End Property
...
#End Region
        ...
        Protected Overrides Sub SetProperties()
            ...
            If String.IsNullOrEmpty(InstructorAuthorizedCalendar) Then
                'since value is the 'default' check the XML file for possible custom setting
                InstructorAuthorizedCalendar = Me.GetLinkValueFromXML(ATTRIBUTE_INSTRUCTOR_AUTHORIZED_CALENDAR)
                If String.IsNullOrEmpty(InstructorAuthorizedCalendar) Then
                    Me.lnkInstructorCalendar.Enabled = False
                    Me.lnkInstructorCalendar.ToolTip = "InstructorAuthorizedCalendar property has not been set."
                Else
                    Me.lnkInstructorCalendar.NavigateUrl = InstructorAuthorizedCalendar
                End If
            Else
                Me.lnkInstructorCalendar.NavigateUrl = InstructorAuthorizedCalendar
            End If
