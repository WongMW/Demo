...
Namespace Aptify.Framework.Web.eBusiness.Education
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Partial Class InstructorValidator__c
        ...
        Private Function IsLecturer() As Boolean
            ...
            Try
                ...
                sql.AppendFormat("..spIsPersonLecturer__c @LoggedInUser={0}", User1.PersonID)
                result = CType(Me.DataAction.ExecuteScalar(sql.ToString()), Boolean)
