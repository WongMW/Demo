            ...
            Try
                ...
                If Convert.ToDecimal(lblTotalAmount.Text.Substring(1, lblTotalAmount.Text.Length - 1)) > 0 Then
                    ...
                    ElseIf cmbWhoPays.SelectedValue = 3 Then
                        ...
                        Else
                            If lblCountry.Text.Trim = "" AndAlso hdnCompanyId.Value > 0 Then
...
#Region "Change Event"
        Protected Sub txtFirmName_TextChanged(sender As Object, e As System.EventArgs) Handles txtFirmName.TextChanged
            Try
                ...
                Dim sCompanyWithCity As String
                If sFirmName.Length >= 1 Then
                    sCompanyWithCity = sFirmName(0) + "/" + sFirmName(1)
                Else
                    sCompanyWithCity = sFirmName(0)
                End If

                Dim iCompanyID As Integer = Convert.ToInt32(AptifyApplication.GetEntityRecordIDFromRecordName("Companies", sCompanyWithCity))
                If iCompanyID <= 0 Then
