<%@ Control Language="VB" AutoEventWireup="false" CodeFile="LLLQualificationStatus__c.ascx.vb"
            ...
            <div>
                ...
                <telerik:RadGrid ID="gvCourseDetails" runat="server" AllowPaging="True" AllowSorting="false"
                    ...
                    <MasterTableView AllowSorting="false">
                        <Columns>
                            <telerik:GridBoundColumn SortExpression="Module" HeaderText="Module" HeaderButtonType="TextButton"
        ...
        <div id="divAssignmentMain" runat="server">
            ...
            <div id="divAssignment" class="collapse">
                ...
                <telerik:RadGrid ID="gvAssignmentStatus" runat="server" AllowPaging="false" AllowSorting="false"
                    AllowFilteringByColumn="False" CellSpacing="0" GridLines="None" ShowFooter="true"
                    ...
                    <MasterTableView AllowSorting="false">
                        <Columns>
                            ...
                            <telerik:GridBoundColumn SortExpression="Percentage" HeaderText="Percentage(%)" HeaderButtonType="TextButton"
                                DataField="Percentage" HeaderStyle-Width="10%" ItemStyle-Width="10%" AllowSorting="false">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn SortExpression="AssignWeightPer__c" HeaderText="Percentage Weighting(%)"
            ...
            <div id="divQualification" class="collapse">
                ...
                <div>
                    <telerik:RadGrid ID="gvQualificationStatus" runat="server" AllowPaging="false" AllowSorting="false"
                        ...
                        <MasterTableView AllowSorting="false">
                            <Columns>
                                <telerik:GridBoundColumn SortExpression="" HeaderText="Module" HeaderButtonType="TextButton"
                                    DataField="Module" HeaderStyle-Width="20%" ItemStyle-Width="5%" AllowSorting="false">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn SortExpression="" HeaderText="Percentage(%)" HeaderButtonType="TextButton"
                                    DataField="Percentage" HeaderStyle-Width="10%" ItemStyle-Width="10%" AllowSorting="false">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn SortExpression="" HeaderText="Percentage Weighting(%)" HeaderButtonType="TextButton"
