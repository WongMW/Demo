...
Namespace Aptify.Framework.Web.eBusiness.Generated
   ...
   ''' <summary>
   ''' Generated ASP.NET Grid User Control for the Meeting Room Types entity.
   ''' </summary>
   ''' <remarks></remarks>
   Partial Class MeetingRoomTypesGridClass
       Inherits Aptify.Framework.Web.eBusiness.BaseUserControlAdvanced

   Protected Const ATTRIBUTE_CONTORL_DEFAULT_NAME As String = "Meeting Room TypesGrid"
      ...
      End Sub
       Protected Overridable Sub LoadGrid()
           Try
               ...
               sSQL = "SELECT ID,Name,Description FROM APTIFY..vwMeetingRoomTypes"
