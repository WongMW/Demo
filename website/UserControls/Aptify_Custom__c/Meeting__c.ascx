...
<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Meeting__c.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.Meetings.Meeting__c" %>
<%@ Register Src="../Aptify_Forums/SingleForum.ascx" TagName="SingleForum" TagPrefix="uc1" %>
<%@ Register TagPrefix="cc2" Namespace="Aptify.Framework.Web.eBusiness" Assembly="EBusinessShoppingCart" %>
<%@ Register TagPrefix="cc1" Namespace="Aptify.Framework.Web.eBusiness" Assembly="AptifyEBusinessUser" %>
<%--<%@ Register Src="~/UserControls/Aptify_Meetings/MeetingActionControl.ascx" TagName="MeetingActionControl" TagPrefix="uc1" %>--%>
<%@ Register TagPrefix="rad" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>
<%--Amruta,IssueID 14380,Code to open register meeting session calendar in new tab --%>
<%@ Register Src="~/UserControls/Aptify_Custom__c/RecordAttachments__c.ascx" TagPrefix="uc3" TagName="RecordAttachments__c" %>
