<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NetworksPointDistributor__c.ascx.vb"
            ...
            <tr>
                <td>
                    <table align="justify" border="1">
                        ...
                        <tr  >
                            <td>
                                Distributed Points To Company Members :
                            </td>
                            <td>
                        ...
                        <tr  >
                            <td>
                                Distributed Points To Network Members :
                            </td>
                            <td>
          ...
          <%--  <tr>
            ...
            <tr id="idNote" runat="server">
                <td>
                    ...
                    <asp:Button ID="btnSubmit" runat="server" Text="Allocate" /> &nbsp; <asp:Button ID="btnDeallocate" runat="server" Text="De-Allocate" />
                </td>
            </tr>
        </table>
