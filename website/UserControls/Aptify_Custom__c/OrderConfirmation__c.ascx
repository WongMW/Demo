...
<%@ Control Language="VB" AutoEventWireup="false" CodeFile="OrderConfirmation__c.ascx.vb"
...
<asp:Button CssClass="submitBtn" ID="btnReceipt" runat="server" Visible="false" Text="Print Receipt"></asp:Button>
                </td>
                </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td colspan="4">
                            <table width="100%">
                                ...
                                <tr>
                                    <td class="LeftMoneyColumn" style="width: 94%;">
                                     <%-- Changes By Ganesh I on 15/04/14--%>
                                        <b>VAT:</b>
                                    </td>
                                    <td class="RightMoneyColumn" style="padding-right: 9px;">
