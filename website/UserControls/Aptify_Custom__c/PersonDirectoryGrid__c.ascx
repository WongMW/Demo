<%@ Control Language="vb" AutoEventWireup="false" CodeFile="PersonDirectoryGrid__c.ascx.vb"
    Inherits="Aptify.Framework.Web.eBusiness.Directories.PersonDirectoryGrid__c" %>
...
<asp:Label ID="lblNoResults" runat="server" Visible="false">No results are available.</asp:Label>
