...
Namespace Aptify.Framework.Web.eBusiness.ProductCatalog
    Partial Class ProductCategory__c
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Try
                ...
                If Not IsPostBack Then
                    ...
                    '        dPrice = GetProductPriceWithCampaign(Me.ControlRecordID, lCampaignID, User1.PersonID, User1.PersonID)
                    '    Else
                    '        dPrice = GetProductPriceWithCampaign(Me.ControlRecordID, lCampaignID, lPersonID, lPersonID)
                    '    End If
