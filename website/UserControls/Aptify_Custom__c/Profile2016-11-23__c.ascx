...
<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Profile__c.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.CustomerService.ProfileControl__c" %>
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <asp:RadioButtonList id=rblPAddress runat="server" AutoPostBack="True" RepeatDirection="Horizontal">
                                            <asp:ListItem>Home Address</asp:ListItem>
                                            <asp:ListItem>Business Address</asp:ListItem>
                                             </asp:RadioButtonList>  <asp:Label ID="Label34" runat="server" Text=""></asp:Label>
                                              </ContentTemplate>
                   </asp:UpdatePanel>  <asp:Label ID="lblPAdressError" runat="server" Text=""></asp:Label>
                                            <div id="output">
                                            </div>
                                        </td>
                                        <td class="RightColumn">&nbsp;
                                    ...
                                    <tr id="trHomeCountry" runat="server" visible="false">
                                        ...
                                        <td class="RigthColumnContactBold">
                                            <asp:DropDownList ID="cmbHomeCountry" CssClass="cmbUserProfileCountry" runat="server"
                                                AutoPostBack="true">
                                            </asp:DropDownList> <asp:Label id="lblErrorHomeCountry" runat ="server" text=""/>
                                            <span class="SpanZipCode">
                                    ...
                                    <tr><td> <asp:Label ID="Label33" runat="server">County:</asp:Label></td>
                                        <td>
                            ...
                            <tr>
                                ...
                                <td class="RightColumn tdRightColumnAreacodephone">
                                    <rad:RadMaskedTextBox ID="txtIntlCode" CssClass="txtUserProfileAreaCodeSmall" runat="server"
                                                Mask="(###)" Width="30%"></rad:RadMaskedTextBox>
...
<rad:radwindow id="RadAddNew" runat="server" width="350px" height="160px" modal="True"
    ...
    <div>
    <div height="35">
    Your Company : <asp:TextBox ID="txtAddNew" onkeydown="javascript:return false" style="background-color: #d8d8bc;" runat="server"></asp:TextBox> 
