        ...
        Private Sub LoadForm()
            Try
                ...
                If User1.UserID > 0 Then
                    ...
                    txtPractice.Enabled = False
                    trPractice.Visible = True
                    LoadUserInfo()
        ...
        Private Sub LoadUserInfo()
            Try
                ...
                With oPerson
                    ...
                    txtTitle.Text = CStr(.GetValue("Title"))
 ...
 'Code added by Govind Mande 16 May 2016
        ...
        Private Function DoSave_Edit() As Boolean
            ...
            Try
                ...
                oPerson.SetValue("Title", txtTitle.Text)
...
#End Region
        ...
        Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
            ...
            CompanyAddress = TextBox1.Text + " " + TextBox5.Text
            CompanyCity = TextBox3.Text
            CompanyCountry = TextBox4.Text
            CompanyState = TextBox6.Text
            Companyphone = txtcode.Text + "-" + TextBox2.Text
            txtCompany.Text = TxtComp.Text + "/" + TextBox3.Text + "/" + TextBox4.Text
            ...
            Try
                ...
                Else
                    ...
                    For Each part In parts
                        ...
                        Exit For
                    Next
                    Dim lcompID As Long = AptifyApplication.GetEntityRecordIDFromRecordName("Companies", txtCompany.Text)
                    Dim oPerson As AptifyGenericEntityBase
                    oPerson = AptifyApplication.GetEntityObject("Persons", User1.PersonID)
