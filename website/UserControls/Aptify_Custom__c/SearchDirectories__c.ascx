<%@ Control Language="vb" AutoEventWireup="false" Inherits="Aptify.Framework.Web.eBusiness.Directories.SearchControl__c"
    CodeFile="SearchDirectories__c.ascx.vb" EnableViewState="true" ViewStateMode="Enabled" %>
<%@ Register TagPrefix="cc2" Namespace="Aptify.Framework.Web.eBusiness" Assembly="EBusinessGlobal" %>
<%@ Register TagPrefix="cc3" Namespace="Aptify.Framework.Web.eBusiness" Assembly="AptifyEbusinessUser" %>
<%@ Register TagPrefix="uc1" TagName="CompanyDirectoryGrid" Src="CompanyDirectoryGrid__c.ascx" %>
<%@ Register TagPrefix="uc1" TagName="PersonDirectoryGrid" Src="PersonDirectoryGrid__c.ascx" %>
