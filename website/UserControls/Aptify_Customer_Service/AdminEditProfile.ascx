<%@ Control Language="VB" AutoEventWireup="false" CodeFile="AdminEditProfile.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.CustomerService.AdminEditProfile" %>
...
<rad:RadWindow ID="radwindowcontact" runat="server" Height="300px" Width="563px"
    Modal="True" BackColor="#f4f3f1" Skin="Default" VisibleStatusbar="False" Behaviors="None" ForeColor="#BDA797"
...
<rad:RadWindow ID="radwindowProfileImage" runat="server" Width="500px" Height="600px"
    ...
    Title="Profile Image" Behavior="None" Skin="Default" IconUrl="~/Images/personal-icon.png" MaxWidth="500px" CssClass="ProfileWindow">
    <ContentTemplate>
