...
#End Region
        ...
        Protected Overridable Sub LoadNotification()
            Try
                ...
                sDB = Me.AptifyApplication.GetEntityBaseDatabase("Meetings")
                sSQL = "EXEC spGetPersonAttendedMeetings__c " & User1.PersonID 'Log #20444 to dispaly only attended meeting
                dt = Me.DataAction.GetDataTable(sSQL, DataServices.IAptifyDataAction.DSLCacheSetting.BypassCache)
                ...
                If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
                    For Each dr In dt.Rows
                        ...
                        'Changed delemeter : to ^ as part #20650
                        ...
                        Dim Desc As String = dr("WebName") & "^ Date of Event is " & dr("StartDate") & If(dr("StartDate") <> dr("EndDate"), "  to  " & dr("EndDate"), "") & "   Your Status -" & dr("AttendeeStatus_Name")
