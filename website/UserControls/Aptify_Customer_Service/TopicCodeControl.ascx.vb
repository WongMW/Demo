...
Namespace Aptify.Framework.Web.eBusiness.CustomerService
    Partial Class TopicCodeControl
        ...
        Public Property TopicFilterCommaList As String
            Get
                Return TopicCodeViewer.TopicFilterCommaList
            End Get
            Set(value As String)
                TopicCodeViewer.TopicFilterCommaList = value
            End Set
        End Property

        Public Property CheckChildNodes As Boolean
            Get
                Return TopicCodeViewer.CheckChildNodes
            End Get
            Set(value As Boolean)
                TopicCodeViewer.CheckChildNodes = value
            End Set
        End Property
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not IsPostBack() Then
                ...
                TopicCodeViewer.RecordID = User1.PersonID
                TopicCodeViewer.ButtonDisplay = False
                Dim lblinterest As Label = CType(TopicCodeViewer.FindControl("lblinterest"), Label)
                lblinterest.Text = "Please Update Your Topics of Interest"
            End If
        End Sub
        ...
        '        Protected Overridable Function RecursiveUpdateTopicCodes(ByVal Nodes As Telerik.Web.UI.RadTreeNodeCollection, ByRef ErrorString As String) As Boolean
        '            Dim i As Integer
        '            Dim sSQL As String
        '            Dim iCount As Long
        '            Dim bOK As Boolean
