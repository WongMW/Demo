...
#End Region
        ...
        Protected Overridable Sub LoadGrid(ByVal isCheckSorting As Boolean)
            Dim sSQL As String
        ...
        Protected Sub grdMyClasses_PageIndexChanging(ByVal sender As Object, ByVal e As GridPageChangedEventArgs) Handles grdMyClasses.PageIndexChanged
            LoadGrid(False)
        End Sub
        Protected Sub grdMyClasses_PageIndexChanging(ByVal sender As Object, ByVal e As GridPageSizeChangedEventArgs) Handles grdMyClasses.PageSizeChanged
            LoadGrid(False)
        End Sub
