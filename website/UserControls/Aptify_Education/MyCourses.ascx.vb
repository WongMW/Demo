...
#End Region
        ...
        Protected Overridable Sub LoadGrid()
            ...
            Try
                ...
                If dt.Rows.Count > 0 Then
                    'For Each row As GridViewRow In grdMyCourses.Rows
                    '    Dim lnk As HyperLink = CType(row.FindControl("lnkWebName"), HyperLink)
                    '    lnk.NavigateUrl = String.Format(ViewClassPage & "?ClassID={0:F0}", dt.Rows((grdMyCourses.PageIndex * grdMyCourses.PageSize) + rowcounter)("ClassID").ToString)
                ...
                Else
                    ...
                    'Me.grdMyCourses.DataSource = dt
                    ''grdMyCourses.DataBind()
                    'grdMyCourses.Items(0).Visible = False
                End If
        ...
        Protected Sub grdMyCourses_PageIndexChanging(ByVal sender As Object, ByVal e As GridPageChangedEventArgs) Handles grdMyCourses.PageIndexChanged
            ''grdMyCourses.PageIndex = e.NewPageIndex
            LoadGrid()
        End Sub
        Protected Sub grdMyCourses_PageIndexChanging(ByVal sender As Object, ByVal e As GridPageSizeChangedEventArgs) Handles grdMyCourses.PageSizeChanged
            ''grdMyCourses.PageIndex = e.NewPageIndex
            LoadGrid()
        End Sub
