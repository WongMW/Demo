<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Search.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.Forums.SearchControl"
    Debug="true" %>
                ...
                <table runat="server" id="tblResults" class="data-form">
                    <tr>
                        <td colspan="2">
                            ...
                            <asp:Button CssClass="submitBtn" ID="cmdChangeSearch" runat="server" Text="Change Search">
                            </asp:Button>
                        </td>
                    </tr>
                    <tr>
