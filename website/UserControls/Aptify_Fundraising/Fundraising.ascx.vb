...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            _ScriptManager.AsyncPostBackTimeout = 2000
        ...
        Private Sub LoadFunds()
            Try
                ...
                sSQL = "SELECT  Distinct p.ID, P.WebName,P.Name FROM " & Database & "..vwProducts P inner join " & Database & "..vwFundCampaignProducts FP on P.ID=FP.ProductID " &
                    "WHERE WebEnabled=1 AND  p.CategoryID=3" ' code added by GM for Redmine #20854
                ' "WHERE WebEnabled=1 And  RootCategory='Fundraising'" ' commented code for Redmine #20854
            ...
            Try
                ...
                If ATTRIBUTE_USEFUNDRASING.Equals(1) AndAlso ATTRIBUTE_IDEFAULTFUNDRAISINGCAMPAINGID > 0 Then
                    If CreatePledge() Then
                        lblMsg.Text = "<span class='ca-thank-msg'>Thank you for your generous contribution!" + "<img class='ca-thank-img' title='Thank you for your generous contribution!' alt='Thank you for your generous contribution!' src='/Images/Thank-you.jpg'></span>" + "<hr>" +
                        "<span class='sf_colsOut sf_1col_1_100' style='display:block'><span class='sf_colsIn sf_1col_1in_100'  style='display:block'><span class='sf_cols' style='display:block'><span class='sf_colsOut sf_2cols_1_50' style='display:block'><span class='sf_colsIn sf_2cols_1in_50' style='display:block'><span class='left-button'><span class='sfContentViews sfSingleContentView' style='display:block'><span class='button-block style-1' style='display:block'><a class='btn-full-width btn' href='/CA-Support/I-need-help/Services-we-offer'><span class='left-arrow lrg-btn-arrow'></span>Services we offer</a></span></span></span></span></span><span class='sf_colsOut sf_2cols_2_50' style='display:block'><span class='sf_colsIn sf_2cols_2in_50' style='display:block'><span class='right-button'><span class='sfContentViews sfSingleContentView' style='display:block'><span class='button-block style-1' style='display:block'><a class='btn-full-width btn' href='/CA-Support/I-want-to-help'><span class='right-arrow lrg-btn-arrow'></span>Can I do more to help?</a></span></span></span></span></span></span></span></span>"
                        tblInner.Visible = False
                        lblMsg.Visible = True
