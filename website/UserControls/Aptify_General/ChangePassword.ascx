...
<asp:UpdatePanel ID="updatepnl" runat="server">
    <ContentTemplate>
        ...
        <div style="padding-top: 10px; margin: 50px 150px 150px 250px;">
            <span height="140px" style="margin-top: 30px;">
                <fieldset style="border: 1px solid gray; width: 320px; padding-bottom: 5px;">
                    <legend class="tdCompanyEditHeader"><b>Change Password</b></legend>
                    <table id="tblLogin" cellspacing="0" cellpadding="0" border="0" runat="server">
                        ...
                        <tr>
                            <td align="right" class="tablecontrolsfontLogin" style="text-align: left; padding-left: 4px; padding-left: 193px; padding-top: 10px;">
                               <%--Neha Issue 14408,02/19/13, Called function on Clientclick --%>
                                <asp:Button ID="btnSave" runat="server" Text="Save" OnClientClick="return ShowvalidationErrorMsg()" CssClass="submitBtn" />&nbsp;
