<%--<%@ Register src="~/UserControls/Aptify_Sitefinity4/Sitefinity4xSSO.ascx" tagname="Sitefinity4xSSO" tagprefix="uc2" %>--%>
...
<%@ Register TagPrefix="uc1" TagName="SocialNetworkingIntegrationControl" Src="~/UserControls/Aptify_General/SocialNetworkingIntegrationControlSF4.ascx" %>
