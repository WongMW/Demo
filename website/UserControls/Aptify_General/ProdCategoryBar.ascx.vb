...
#End Region
        ...
        Private Sub LoadMenu(ByRef ParentMenu As RadMenuItem, _
            ...
            Try
                ...
                sSQL = Me.Database & "..spGetProductCategoriesForMenu__c"
                Dim param(0) As IDataParameter

                param(0) = DataAction.GetDataParameter("@lParentID", SqlDbType.Int, lParentID)
                ...
                If lParentID <= 0 Then
                    ...
                    ''Added By Pradip 2016-08-11 for Static Menu for Diplomas
                    oMenu = New RadMenuItem
                    mnuItems.Add(oMenu)
                    oMenu.Text = "Diplomas"
                    oMenu.Value = "-1"
                    oMenu.NavigateUrl = "~/lll/lllcourses.aspx"
