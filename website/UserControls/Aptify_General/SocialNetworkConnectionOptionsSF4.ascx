...
<%@ Control Language="VB" AutoEventWireup="false" CodeFile="SocialNetworkConnectionOptionsSF4.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.SocialNetworkConnectionOptions"%>
