<%@ Control Language="VB" AutoEventWireup="false" CodeFile="SocialNetworkTermsNConditions.ascx.vb" Inherits="UserControls_Aptify_General_SocialNetworkTermsNConditions" %>
