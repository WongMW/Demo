...
#Region "Functions and Methods"
        Private Sub GetEvent()
            ...
            Dim bShowMeeting As Boolean = ShowMeetingsLinkToClass()
            Try
                sSQL = "SELECT distinct vwp.Productid,  case when (vp.WebName is null or vp.WebName = '') 	then vp.Name 	Else vp.WebName End as MeetingTitle,  vp.ClassID " & _
                          "FROM " & _
                          Database & _
        ...
        Private Sub GetEventPast()
            ...
            Dim bShowMeeting As Boolean = ShowMeetingsLinkToClass()
            Try
                sSQL = "SELECT distinct vwp.Productid,case when (vp.WebName is null or vp.WebName = '') 	then vp.Name 	Else vp.WebName End as MeetingTitle " & _
                          "FROM " & _
                          Database & _
...
#End Region
        ...
        Private Sub AddExpression()
            ...
            ExpOrderSort.FieldName = "MeetingTitle"
