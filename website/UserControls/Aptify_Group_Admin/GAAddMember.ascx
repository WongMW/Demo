...
<%--  Aparna 14317 Excel upload--%>
 <br /><br /><asp:Label runat="server" Text="OR" Font-Bold="true" ></asp:Label><br /><br /><br />
<table class="excelFormatTable">
    <tr>
    ...
    <tr>
        ...
        <td class="excelTdWidthexport ExportExcelPadding" > 
            ...
            <div class="excelImgDiv" >  <rad:RadBinaryImage ID="radImgSmallExcel"  ImageUrl="~/Images/Excel_ICO.png"  runat="server" Visible="false" /></div>
        </td>
    </tr>
    <tr>
        <td class="excelTdWidthexport"></td>
        <td class="excellblmsg">
            <asp:Label ID="lblMessage" runat="server" Text="" ForeColor="Red"></asp:Label>
        </td>
        <td class="excelTdWidth"></td>
    </tr>
</table>
