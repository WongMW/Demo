        ...
        Private Sub LoadGrid()
            ...
            Try
                ...
                If ViewState(ATTRIBUTE_ORDERHISTORYADMIN_VIEWSTATE) Is Nothing Then
                    ...
                    sSQL = "select o.BillToCompany,o.ID,o.OrderDate,o.PayType,CONVERT(VARCHAR,o.balance,1) As 'balance',ct.CurrencySymbol,ct.NumDigitsAfterDecimal,o.CurrencyType,o.ShipDate,CONVERT(VARCHAR,CALC_GrandTotal,1)as 'CALC_GrandTotal',o.OrderStatus,o.ShipType,o.ShipTrackingNum,o.BillToName,o.ShipToName " & _
                           " FROM " & Database & _
