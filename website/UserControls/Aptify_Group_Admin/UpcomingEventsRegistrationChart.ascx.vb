...
#End Region
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
             ' Response.Redirect(Me.GetSecurityErrorPageFromXML & "?Message=Access to this Manage My Group is unauthorized.")
            SetProperties()
            If Not Page.IsPostBack Then
                ''Dim oCommonMethods As New Aptify.Framework.Web.eBusiness.CommonMethods(DataAction, AptifyApplication, user1, Database)

                ''If Not oCommonMethods.GetFirmAdmin(user1.PersonID) Then
                    ''Response.Redirect(Me.GetSecurityErrorPageFromXML & "?Message=Access to this Manage My Group is unauthorized.")
                ''End If
