...
#End Region
 ...
 ''Added By Pradip 20106-08-17 for Redmine issue https://redmine.softwaredesign.ie/issues/15216
        ...
        Sub CheckGroupAdmin()
            ...
            'suraj remove the params(1) = Me.DataAction.GetDataParameter("@CompanyID", SqlDbType.BigInt, User1.CompanyID) and insteade of Dim params(1) i made Dim params(0) as per rashmi requirement.
            SQL = Database & ".." & "spFindPersonByID"
            params(0) = Me.DataAction.GetDataParameter("@ID", SqlDbType.BigInt, User1.PersonID)
            DT = Me.DataAction.GetDataTableParametrized(SQL, CommandType.StoredProcedure, params)
            If DT IsNot Nothing AndAlso DT.Rows.Count > 0 Then
                If DT.Rows(0).Item("IsGroupAdmin") Then
