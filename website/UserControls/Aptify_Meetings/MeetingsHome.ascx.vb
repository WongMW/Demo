...
#End Region
            ...
            Try
                ...
                Else
                    ...
                    If tempFWNewdt.Rows.Count > 0 Then
                        Me.grdMeetings.DataSource = ViewState(ATTRIBUTE_MEETINGSHOMEDT_VIEWSTATE)
                        'Suraj issue 14457 , 4/3/13 , remove Me.grdMeetings.DataBind()
                    End If
                End If
            Catch ex As Exception
                Aptify.Framework.ExceptionManagement.ExceptionManager.Publish(ex)
        ...
        Protected Sub grdMeetings_PageIndexChanged(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridPageChangedEventArgs) Handles grdMeetings.PageIndexChanged
            LoadSchedule()
        End Sub
        Protected Sub grdMeetings_PagesizeIndexChanged(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridPageSizeChangedEventArgs) Handles grdMeetings.PageSizeChanged
            LoadSchedule()
        End Sub
