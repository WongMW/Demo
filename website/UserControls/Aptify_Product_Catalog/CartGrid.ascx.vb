...
#End Region
        ...
        Public Sub RefreshGrid()
            ...
            Try
                ...
                ''Added By Pradip For Issue No https://redmine.softwaredesign.ie/issues/14046
                For Each dr As DataRow In dt.Rows
                    Dim des As String = CStr(dr.Item("Description"))
                    If des.Trim <> "" Then
                        If System.Text.RegularExpressions.Regex.Replace(des, "<[^>]*>", "").Trim.Length > 150 Then
                            dr("Description") = System.Text.RegularExpressions.Regex.Replace(des, "<[^>]*>", "").Trim.Substring(0, 150).Trim() + "..."
                        End If
                    End If
                Next
                ''End here Added By Pradip For Issue No https://redmine.softwaredesign.ie/issues/14046
        ...
        Protected Sub grdMain_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles grdMain.DataBound
            ...
            For Each row As GridDataItem In grdMain.Items
                ...
                DirectCast(row.FindControl("link"), HyperLink).NavigateUrl = _
        ...
        Private Sub AddGMTRemoveFromCart(oOrder As Aptify.Applications.OrderEntry.OrdersEntity, index As Integer)
            ...
            orderLine = oOrder.SubTypes("OrderLines")(index)
