                ...
                If dt.Rows.Count > 0 Then
                    For Each rw As DataRow In dt.Rows
                        ...
                        For intLoopIndex = 0 To dt.Rows.Count - 1
                            rw("ProductUrl") = SetURLPerProductType(ShoppingCart1.GetOrderObject(Page.Session, Page.User, Page.Application), intLoopIndex)
 ...
 ''' <summary>
        ...
        Protected Sub grdMain_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles grdMain.DataBound
            ...
            For Each row As GridDataItem In grdMain.Items
                ...
                SetURLPerProductType(ShoppingCart1.GetOrderObject(Page.Session, Page.User, Page.Application), rowcounter)
