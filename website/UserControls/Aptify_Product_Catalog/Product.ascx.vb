...
#End Region
        ...
        Protected Overrides Sub SetProperties()
            ...
            If ShoppingCart1.GetOrderObject(Page.Session, Page.User, Page.Application) IsNot Nothing Then
        ...
        Private Sub lnkAddToCart_ServerClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkAddToCart.Click
            ...
            Try
                ...
                Else
                    ...
                    If ShoppingCart1.AddToCart(Me.ProductID, Me.User1.PersonID, bCombineLines, , iQty) Then
        ...
        Protected Sub lnkViewCart_Click(sender As Object, e As System.EventArgs) Handles lnkViewCart.Click
            Response.Redirect(ViewcartPage)
        End Sub
    End Class
End Namespace
