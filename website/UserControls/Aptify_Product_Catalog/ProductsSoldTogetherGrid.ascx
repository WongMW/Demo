<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ProductsSoldTogetherGrid.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.ProductCatalog.ProductsSoldTogether" %>
