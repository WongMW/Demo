    ...
    Partial Class SaveCartControl
        ...
        Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
            Try
                ...
                If lCartID > 0 Then
                    lblResult.Text = "Your shopping cart has been saved!" &
                                     "<BR>If you would like to use this saved cart, simply go to 'My Account' area and select 'Saved cart' from the options." &
                                      "<BR>For your reference the Cart ID is: " & lCartID
