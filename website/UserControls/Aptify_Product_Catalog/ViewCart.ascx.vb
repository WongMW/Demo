...
#End Region
        ...
        Private Sub RefreshGrid()
            Try
                ...
                With CartGrid.Cart
                    ...
                    lblGrandTotal.Text = Format$(.GrandTotal, .GetCurrencyFormat(.CurrencyTypeID))
                    ...
                    If User1.PersonID > 0 Then
                        ...
                        'Dim memCost As Decimal = ShoppingCart1.GetProductMemberCost(Me.Page.User, CLng(dr.Item("ID")))
                        'Dim nonmemCost As Decimal = ShoppingCart1.GetProductNonMemberCost(Me.Page.User, CLng(dr.Item("ID")))
                        'dSavings = nonmemCost - memCost
                        Dim dSavings As Decimal
        ...
        Private Sub cmdUpdateCart_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdUpdateCart.Click
            ...
            Try
                CartGrid.UpdateCart()
                RefreshGrid()
                'Added by sandeep for issue on 07/03/2013
                'If Cart have only one row then Shipping type should be reset
