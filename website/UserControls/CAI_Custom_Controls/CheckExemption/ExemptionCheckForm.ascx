<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ExemptionCheckForm.ascx.cs" Inherits="SitefinityWebApp.UserControls.CAI_Custom_Controls.CheckExemption.ExemptionCheckForm" %>
...
<div class="container-fluid bootstrap-style" id ="f1">
        <div class="row-fluid" >
                    <form  id="form1"  class="form-horizontal" >
                      <fieldset>
                            <legend class="text-center" style="color:#861F41">Check your exemption </legend>
