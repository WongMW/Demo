...
{
    public partial class ExemptionCheckForm : System.Web.UI.UserControl
    {
        ...
        { 
                ...
                using (SqlCommand cmd = new SqlCommand("spCreateWebStagingStudentLeads__cai"))
                {
                    ...
                    //@InteractionDetail Default to Exemption check form  for Exemption check form 
                    cmd.Parameters.Add(new SqlParameter("@InteractionDetail", "Exemption check form"));
                    ...
                    // insert null into contact text areay
                                ...
                                if (ival > 0)
                                {
                                    ...
                                    Response.Redirect("/Prospective-Students/Apply-and-Join/check-your-exemptions");
