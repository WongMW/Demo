...
Namespace Aptify.Framework.Web.eBusiness.Generated
   ...
   ''' <summary>
   ''' Generated ASP.NET Grid User Control for the Meeting Rooms entity.
   ...
   ''' </summary>
   ''' <remarks></remarks>
   Partial Class MeetingRoomsGridClass
       Inherits Aptify.Framework.Web.eBusiness.BaseUserControlAdvanced

   Protected Const ATTRIBUTE_CONTORL_DEFAULT_NAME As String = "Meeting RoomsGrid"
      ...
      End Sub
       Protected Overridable Sub LoadGrid()
           Try
               ...
               sSQL = "SELECT ID,Name,Description,Parent,Venue,Width,Depth,HandicapAccess,MeetingTypesAllowed,ChargeableProduct FROM APTIFY..vwMeetingRooms"
