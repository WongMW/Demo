<%@ Control Language="vb" AutoEventWireup="false" Inherits="Aptify.Framework.Web.eBusiness.Generated.MeetingRoomsGridClass" CodeFile="MeetingRoomsGrid_NoBootstrap__cai.ascx.vb" %>
...
<div class="content-container clearfix"> 
    <table runat="server" id="tblMain" class="data-form">
       <tr>
           <td>
               <asp:Button id="cmdNewRecord" Text="New Meeting Rooms Record" Runat="server" /> 
           </td>
       </tr>
       <tr>
           <td>
