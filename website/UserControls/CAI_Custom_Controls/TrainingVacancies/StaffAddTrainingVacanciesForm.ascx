<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StaffAddTrainingVacanciesForm.ascx.cs" Inherits="SitefinityWebApp.UserControls.CAI_Custom_Controls.TrainingVacancies.StaffAddTrainingVacanciesForm" %>
...
<div class="container-fluid bootstrap-style" id="f1" style="padding-bottom:150px;">
        ...
        <div class="row-fluid" >
            <div class="container-fluid">
                ...
                <form  class="addform form-horizontal" method="post" id="addform">
                      <fieldset>
                         ...
                         <div class="form-group row">
                              <label class="col-sm-2 col-form-label required" for="email">Vacancy type</label>  
                                <div class="col-sm-10">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 pill-list extra-space"><%--WongS, Ticket #20924--%></div>
                                    </div>
                               </div>
                          </div>
                         <!--  Train In Type -->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10"> 
                              <div class="">
                                  <asp:textbox id="fjobspec" runat="server"  class="form-control char-max-500" placeholder="Job specificatio (500 characters max)"  TextMode="multiline" rows="7" name="fjobspec"></asp:textbox><%-- WongS, Ticket #20924 --%>
                            <div class="char-count"><span class="chars-num" style="font-weight:bold;">500</span> characters remaining</div><%-- WongS, Ticket #20924 --%>
                               </div>
                             </div>
                         </div>
                        <!--  Job Requeriments -->
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label required" for="ddi">Job requirements</label>
                            <div class="col-md-10"> 
                              <div class="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="text-right">
                            <asp:Button ID="btnSave" runat="server" Text="Add Training Vacancy" class="submitBtn valAndsubmitBtn"   OnClick="btnSave_Click" />                            
                            <asp:Button ID="btnCancel" runat="server" Text="Cancel" class="cancelBtn"   OnClick="btnCancel_Click" />
                        </div>
                        <% }
                            else
                            { %>
                        <div class="text-right">
                            <asp:Button ID="btnEditSave" runat="server" Text="Save changes" class="submitBtn valAndsubmitBtn"   OnClick="btnUpdate_Click" />
                            <asp:Button ID="btnEditCancel" runat="server" Text="Cancel" class="cancelBtn"  />
                        </div>
                        <% }  %>
                    </div>
                  </fieldset>
