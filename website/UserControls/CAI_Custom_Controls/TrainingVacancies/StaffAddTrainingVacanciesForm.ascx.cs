...
{
    public partial class StaffAddTrainingVacanciesForm : Aptify.Framework.Web.eBusiness.BaseUserControlAdvanced                                        
    {
        ...
        public delegate void EditStatusDelegate(int TVID,int companyID, string companyName);
        ...
        public void SetCompanyDetails(int id, string name)
        {
            this.CompanyID = id;
            this.CompanyName = name;
            ViewState["CompanyID"] = id;
            ViewState["CompanyName"] = name;
        }
        ...
        public void LoadData()
        {
                ...
                {
                    this.CompanyID = int.Parse(ViewState["CompanyID"].ToString());
                }
                if (ViewState["CompanyName"] != null)
                {
                    this.CompanyName = ViewState["CompanyName"].ToString();
                }
                ffirmid.Value = "" + this.CompanyID;
                fpersonid.Value = "" + User1.PersonID;
                fcname.Text = this.CompanyName;
        ...
        protected void btnCancel_Click(object sender, EventArgs e)
        {
            ...
            if (this.Mode == Modes.Add)
            {
                ...
                GetTVID(this.id, spfirmid, spcompanyname);
            }
...

        {
            ...
            try
            {
                ...
                if (eeid > 0)
                {
                    GetTVID(eeid,spfirmid,spcompanyname);
                }
