<%@ Control Language="vb" AutoEventWireup="false" Inherits="Aptify.Framework.Web.eBusiness.AbstractManagement.SubmitAbstract" CodeFile="~/UserControls/Aptify_Abstract_Management/SubmitAbstract.ascx.vb" %>
