<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Chapters/ChapterEdit.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.Chapters.ChapterEditControl" %>
...
<div class="content-container clearfix">
    <table id="tblMain" runat="server" class="data-form">
          ...
          <asp:Button ID="cmdChapter" runat="server" Text="Go To Chapter" CssClass="submitBtn" CausesValidation="false"   />
          </td>
                </tr>
  </table>
