<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Chapters/ChapterMeeting.ascx.vb"
    ...
    <table id="tblMain" runat="server" class="data-form">
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <asp:LinkButton ID="lnkChapter" runat="server" CausesValidation="false">Go To Chapter</asp:LinkButton>
            </td>
        </tr>
    </table>
