<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Chapters/ChapterReportViewer.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.Chapters.ChapterReportViewerControl" Debug = "true" %>
