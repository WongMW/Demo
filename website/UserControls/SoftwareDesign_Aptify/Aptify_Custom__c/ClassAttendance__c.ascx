<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Custom__c/ClassAttendance__c.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.Education.ClassAttendance__c" %>
