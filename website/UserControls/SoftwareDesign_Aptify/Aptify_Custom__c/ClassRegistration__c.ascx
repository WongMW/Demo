...
<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Custom__c/ClassRegistration__c.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.Education.ClassRegistration__c" %>
...
<div class="content-container clearfix">
    <table id="tblMain" runat="server" class="data-form">
        ...
        <tr>
          ...
          <tr>
                <td colspan="2" style="border-right: gray 1px solid; border-top: gray 1px solid;
                vertical-align: top; border-left: gray 1px solid">
        ...
        <tr>
            <td colspan="2" style="border-right: gray 1px solid; border-top: gray 1px solid; vertical-align: top; border-left: gray 1px solid">
