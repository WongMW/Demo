<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Custom__c/CompanyEdit__c.ascx.vb"
        ...
        <div class="cai-form">
            ...
            <div class="cai-form-content">
                <div class="edit-content-button">
                    ...
                    <asp:LinkButton ID="contact" ForeColor="#8C1D40" runat="server" Text="Edit" />
                </div>
            ...
            <div class="cai-form-content">
                ...
                <div>
                    ...
                    <div class="edit-content-button">
                        ...
                        <asp:LinkButton ID="btnTopicIntrest" runat="server" ForeColor="#8C1D40" Text="Edit"
                        ...
                        <asp:UpdatePanel ID="updatepnl" runat="server">
                            <ContentTemplate>
                                <div class="cai-form">
                                        ...
                                        <div id="Td34" align="left" class="RigthColumnContactBold" runat="server" style="padding-bottom: 5px; padding-left: 2px;">
                                            <asp:DropDownList ID="cmbCountry" CssClass="cmbUserProfileCountry"
                                             ...
                                             <asp:RequiredFieldValidator ControlToValidate="cmbCountry" ID="RequiredFieldValidator1"
                                                ...
                                                InitialValue="0" runat="server" ForeColor="Red" Display="Dynamic" ValidationGroup="VldAdressInfo">
                                    ...
                                    <div id="trBillingCountry" runat="server" visible="False">
                                        ...
                                        <div class="RigthColumnContactBold tdRightColumnCompanyEdit" runat="server">
                                            <asp:DropDownList ID="cmbBillingCountry" CssClass="cmbUserProfileCountry"
                                              ...
                                              <asp:RequiredFieldValidator ControlToValidate="cmbBillingCountry" ID="RequiredFieldValidator2"
                                                ErrorMessage="Please select a country"
                                                InitialValue="0" runat="server" ForeColor="Red" Display="Dynamic" ValidationGroup="VldAdressInfo">
                                            </asp:RequiredFieldValidator>
                                            <span class="SpanZipCode">
                                    ...
                                    <div id="trPOBoxCountry" runat="server" visible="False">
                                        ...
                                        <div class="RigthColumnContactBold tdRightColumnCompanyEdit" runat="server">
                                            <asp:DropDownList ID="cmbPOBoxCountry" CssClass="cmbUserProfileCountry"
                                             ...
                                             <asp:RequiredFieldValidator ControlToValidate="cmbPOBoxCountry" ID="RequiredFieldValidator3"
                                                ErrorMessage="Please select a country"
                                                InitialValue="0" runat="server" ForeColor="Red" Display="Dynamic" ValidationGroup="VldAdressInfo">
                                            </asp:RequiredFieldValidator>
                                            <span class="SpanZipCode">
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" Display="Dynamic"
                                        ControlToValidate="txtEmail" ErrorMessage="Invalid Email Format2"
                                        ForeColor="Red" ValidationGroup="VldAdressInfo"></asp:RegularExpressionValidator>
