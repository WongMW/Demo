<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Custom__c/EditListing__c.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.MarketPlace.EditListing"  %>
...
<%@ Register TagPrefix="uc1" TagName="ListingDisplay" Src="~/UserControls/Aptify_Marketplace/ListingDisplay.ascx" %>
<%@ Register TagPrefix="cc3" Namespace="Aptify.Framework.Web.eBusiness" Assembly="AptifyEBusinessUser" %>
<%@ Register TagPrefix="uc2" TagName="TopicCodeViewer" Src="~/UserControls/Aptify_General/TopicCodeViewer.ascx" %>
<%@ Register TagPrefix="uc1" TagName="ListingEdit" Src="ListingEdit__c.ascx" %>
