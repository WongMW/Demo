<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Custom__c/ExpoRegistration__c.ascx.vb"Inherits="Aptify.Framework.Web.eBusiness.ProductCatalog.ExpoRegistration__c" %>
                    ...
                    <tr>
                        ...
                        <td class="RightColumn">
                            ...
                            <asp:RegularExpressionValidator ID="regexPCEmailValid" ValidationGroup="VldSaveBooth"
                                runat="server" ValidationExpression="[a-zA-Z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-zA-Z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-zA-Z0-9](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?\.)+(?:[A-Z]{2}|com|COM|org|ORG|net|NET|edu|EDU|gov|GOV|mil|MIL|biz|BIZ|info|INFO|mobi|MOBI|name|NAME|aero|AERO|asia|ASIA|jobs|JOBS|museum|MUSEUM|in|IN|ie|IE|co|CO)\b"
