<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Custom__c/FirmChangeSessionToAutumn__c.ascx.vb"
...
<telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                ...
                <div class="info-data">
                    <div class="row-div clearfix">
                        <div class="label-div w20">
                            <asp:Label ID="lblAcademicYear" runat="server" Font-Bold="True" Text="Academic year: "></asp:Label>
                        </div>
                ...
                <div class="info-data">
                    <div class="row-div clearfix">
                        ...
                        <div class="field-div1 w80" align="left">
                            <asp:Label ID="lblGroupMsg" runat="server" Font-Bold="True" Text="Student group not available"></asp:Label>
                        </div>
                    </div>
                    <div class="row-div clearfix">
                        <div class="label-div w10">
                        ...
                        <div class="field-div1 w80" align="left">
                            <asp:Label ID="lblAutumnMsg" runat="server" Font-Bold="True" Text="Enrolled on autumn"></asp:Label>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div>
        <table width="100%">
            <tr>
                <td colspan="2">
                    <asp:Label ID="lblStudCount" runat="server" Font-Bold="True" ></asp:Label>
                </td>
            </tr>
            <tr>
                <td width="25%"></td>
                <td width="30%"><asp:Button ID="btnBack" runat="server" Text="Manage My Students" class="submitBtn" />
