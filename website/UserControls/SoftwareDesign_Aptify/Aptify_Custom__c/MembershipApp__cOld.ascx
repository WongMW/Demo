...
<div class="cai-form">
            ...
            <div class="cai-form-content">
                ...
                <div class="form-section-half">
                    <div class="field-group">
                        ...
                        <asp:TextBox ID="TxtLine3" runat="server"></asp:TextBox>
                ...
                <div class="field-group">
                    ...
                    <rad:RadDatePicker ID="rdpBirthdate" runat="server" Calendar-ShowOtherMonthsDays="false"
    ...
    <div id="idEvevationProg" runat="server" visible="false">
        <asp:Panel ID="pnlEvevationProg" runat="server">
            <span class="form-title expand">ELEVATION PROGRAMME
                <span style="float: right;">
