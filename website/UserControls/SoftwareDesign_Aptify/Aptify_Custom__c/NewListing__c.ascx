<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Custom__c/NewListing__c.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.MarketPlace.NewListing"%>
