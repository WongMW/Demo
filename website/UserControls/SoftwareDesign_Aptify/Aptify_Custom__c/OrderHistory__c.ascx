<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Custom__c/OrderHistory__c.ascx.vb"
...
&nbsp;
 ...
 <telerik:GridBoundColumn DataField="ID" HeaderText="Order #" SortExpression="ID" AutoPostBackOnFilter="true" CurrentFilterFunction="EqualTo" ShowFilterIcon="false"  />
			                ...
			                <rad:GridButtonColumn HeaderText="Invoice" Text="Print invoice" UniqueName="Invoicereport" CommandName="Invoicereport" ButtonCssClass="cai-btn cai-btn-navy-inverse"></rad:GridButtonColumn>
                            <rad:GridButtonColumn HeaderText="Receipt" Text="Print receipt" UniqueName="Paymentreceipt" CommandName="Paymentreceipt" ButtonCssClass="cai-btn cai-btn-navy-inverse"></rad:GridButtonColumn>
                        </Columns>
                    </MasterTableView>
                </rad:RadGrid>
            </ContentTemplate>
