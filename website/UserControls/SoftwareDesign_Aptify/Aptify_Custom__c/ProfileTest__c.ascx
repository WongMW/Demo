...
<%@ Control Language="VB" AutoEventWireup="false" Inherits="Aptify.Framework.Web.eBusiness.CustomerService.ProfileTest__c" Codebehind="~/UserControls/Aptify_Custom__c/ProfileTest__c.ascx.vb" %>
...
<script type="text/javascript" language="javascript">
    ...
    function ShowChangeCompany() {
        var hid = document.getElementById("baseTemplatePlaceholder_content_ProfileTest__c_hidCheckFlag");
        hid.value = "Edit";
...
<asp:Button ID="btnDeleteAddress" AlternateText="Delete" runat="server" Text="Delete" CssClass="submitBtn" />
                                    </div>
                                </ItemTemplate>
 ...
 <div style="text-align: right;">
                            <input id="btnAddanotherbusiness" type="button" onclick="AddAnotherBusiness()" class="submitBtn" value="Add another address" />
                        </div>
                    </div>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="button" id="Removethiscompanyrecord" value="Remove this company record" onclick="ShowDeleteCompany();" class="submitBtn">
