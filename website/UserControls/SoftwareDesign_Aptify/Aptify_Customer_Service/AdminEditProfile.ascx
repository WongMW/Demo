<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Customer_Service/AdminEditProfile.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.CustomerService.AdminEditProfile" %>
                    ...
                    <table id="tblProfileImg" cellpadding="0px" cellspacing="0px">
                        ...
                        <tr>
                            <td align="right">
                                ...
                                <asp:LinkButton ID="lbtnOpenProfileImage" ForeColor="#d07b0c" runat="server" Text="Edit" CausesValidation="false" />
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <td>
                    <table width="100%">
                        <tr>
                            ...
                            <td align="right">
                                <asp:Label ID="lblmsg" runat="server" Text="" ForeColor="#00AFA9"></asp:Label>
                                <br />
                                ...
                                <asp:Button ID="btnsend" runat="server" Text="Send Notification" Width="112px" class="submitBtn" Height="23px"/>
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <div>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                             ...
                             <table>
                             <tr>
                                <td id="lblphonetitle" runat="server" class="LeftColumnAdminContactinfo lblAdminEditProfile" style="font-weight: bold;">
                                    (Area Code) Phone:
                                </td>
                           ...
                           <table>
                           <tr>
                                <td id="lblFaxtitle" runat="server" class="LeftColumnAdminContactinfo lblAdminEditProfile" style="font-weight: bold;">
                                    (Area Code) Fax:
                                </td>
                                <td class="RightColumnContactAdmin" >
...
<rad:RadWindow ID="radwindowPopup" runat="server" Width="350px" Height="100%" Modal="True"
    BackColor="#DADADA" VisibleStatusbar="False" Behaviors="None" ForeColor="#BDA797"
    Title="Personal Information" Behavior="None" CssClass="pop-up" Skin="Default" IconUrl="~/Images/personal-icon.png">
    <ContentTemplate>
...
<rad:RadWindow ID="radwindowcontact" runat="server" Height="100%" Width="563px"
    Modal="True" BackColor="#f4f3f1" Skin="Default" CssClass="pop-up" VisibleStatusbar="False" Behaviors="None" ForeColor="#BDA797"
    Title="Contact Information" Behavior="None" IconUrl="~/Images/contact-icon.png">
    <ContentTemplate>
                ...
                <ContentTemplate>
                    <table width="100%" cellpadding="0" cellspacing="0" style="height: 100%; padding-left: 5px;
                        ...
                        <tr id="trAddressLine1" runat="server">
                            <td id="Td1" class="LeftColumnEditProfile" runat="server" style="padding-right:5px" align="right">
                        ...
                        <tr id="trHomeAddressLine1" runat="server" visible="False">
                            <td id="Td3" class="LeftColumnEditProfile" runat="server" style="padding-right:5px" align="right">
                        ...
                        <tr id="trBillingAddressLine1" runat="server" visible="False">
                            <td id="Td5" class="LeftColumnEditProfile" runat="server" style="padding-right:5px" align="right">
                        ...
                        <tr id="trPOBoxAddressLine1" runat="server" visible="False">
                            <td id="Td7" class="LeftColumnEditProfile" runat="server" style="padding-right:5px" align="right">
                        ...
                        <tr id="trCity" runat="server">
                            <td id="Td25" class="LeftColumnEditProfile" runat="server" style="padding-right:5px" align="right">
                                <asp:Label ID="lblCityStateZip" runat="server" Font-Bold="true">City:</asp:Label>
                            </td>
                            <td id="Td26" class="RigthColumnContactBold EditContactPaddingLeft" runat="server" style="padding-bottom:5px;">
                        ...
                        <tr id="trHomeCity" runat="server" visible="False">
                            <td id="Td27" class="LeftColumnEditProfile" colspan="1" runat="server" style="padding-right:5px" align="right">
                                <asp:Label ID="Label9" runat="server" Font-Bold="true">City:</asp:Label>
                            </td>
                            <td id="Td28" class="RigthColumnContactBold EditContactPaddingLeft" runat="server" style="padding-bottom: 5px;" >
                        ...
                        <tr id="trBillingCity" runat="server" visible="False">
                            <td id="Td29" class="LeftColumnEditProfile" colspan="1" runat="server" style="padding-right:5px" align="right">
                                <asp:Label ID="Label10" runat="server" Font-Bold="true">City:</asp:Label>
                            </td>
                            <td id="Td30" class="RigthColumnContactBold EditContactPaddingLeft" runat="server" style="padding-bottom: 5px;">
                        ...
                        <tr id="trPOBoxCity" runat="server" visible="False">
                            <td id="Td31" class="LeftColumnEditProfile" colspan="1" runat="server" style="padding-right:5px;padding-left: 4px;" align="right">
                                <asp:Label ID="Label11" runat="server" Font-Bold="true">City:</asp:Label>
                            </td>
                            <td id="Td32" class="RigthColumnContactBold EditContactPaddingLeft" runat="server" style="padding-bottom: 5px;">
                        ...
                        <tr id="trCountry" runat="server">
                            <td id="Td33" class="LeftColumnEditProfile" colspan="1" runat="server" style="padding-right:5px" align="right">
                                <asp:Label ID="lblCountry" runat="server" Font-Bold="true">Country:</asp:Label>
                            </td>
                            <td id="Td34" align="left" class="RigthColumnContactBold EditContactPaddingLeft" runat="server" style="padding-bottom: 5px;">
                        ...
                        <tr id="trHomeCountry" runat="server" visible="False">
                            <td id="Td35" class="LeftColumnEditProfile" colspan="1" runat="server" style="padding-right:5px" align="right">
                                <asp:Label ID="Label13" runat="server" Font-Bold="true">Country:</asp:Label>
                            </td>
                            <td id="Td36" class="RigthColumnContactBold EditContactPaddingLeft" runat="server" style="padding-bottom: 5px;">
                        ...
                        <tr id="trBillingCountry" runat="server" visible="False">
                            <td id="Td37" class="LeftColumnEditProfile" colspan="1" runat="server" style="padding-right:5px" align="right">
                                <asp:Label ID="Label16" runat="server" Font-Bold="true">Country:</asp:Label>
                            </td>
                            <td id="Td38" class="RigthColumnContactBold EditContactPaddingLeft" runat="server" style="padding-bottom: 5px;">
                        ...
                        <tr id="trPOBoxCountry" runat="server" visible="False">
                            <td id="Td39" class="LeftColumnEditProfile" colspan="1" runat="server" style="padding-right:5px" align="right">
                                <asp:Label ID="Label17" runat="server" Font-Bold="true">Country:</asp:Label>
                            </td>
                            <td id="Td40" class="RigthColumnContactBold EditContactPaddingLeft" style="padding-bottom: 5px;" runat="server">
                        ...
                        <tr>
                            ...
                            </td><%--Neha Issue 14750 ,02/26/13, added css for phoneareacode--%>
                        ...
                        <tr>
                            ...
                            <td class="RightColumn">
                                ...
                                <rad:RadMaskedTextBox ID="txtFaxPhone" runat="server" CssClass="txtUserProfileAreaCode" Mask="###-####" Width="65px"></rad:RadMaskedTextBox>
                                 <asp:Label ID="lblFaxMsg" runat="server" Font-Bold="true" Text="Please Enter Fax Phone" Visible="false" ForeColor="Red"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td style="height: 5px">
        ...
        <div style="background-color: #f4f3f1;"  class="PaddingrightContact" align="right">
           ...
           <asp:Button ID="btncontactsave" class="submitBtn" OnClientClick="return validatephone();" Width="70px" runat="server" Text="Save"
                OnClick="btncontactsave_Click" Height="23px" />&nbsp;&nbsp;
...
<rad:RadWindow ID="radtopicintrest" runat="server" Width="500px" Height="100%" Modal="True"
...
<rad:RadWindow ID="radwindowProfileImage" runat="server" Width="500px" Height="100%"
    Modal="True" BackColor="#DADADA" VisibleStatusbar="False" Behaviors="None" ForeColor="#BDA797"
    Title="Profile Image" Behavior="None" Skin="Default" IconUrl="~/Images/personal-icon.png" MaxWidth="500px" CssClass="ProfileWindow pop-up">
    <ContentTemplate>
