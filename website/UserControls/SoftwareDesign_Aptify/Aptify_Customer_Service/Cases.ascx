<%@ Control Language="vb" AutoEventWireup="false" Inherits="Aptify.Framework.Web.eBusiness.Generated.CasesClass" CodeFile="~/UserControls/Aptify_Customer_Service/Cases.ascx.vb" %>
