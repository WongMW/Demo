<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Customer_Service/MyMeetings.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.CustomerService.MyMeetings" %>
<%@ Register TagPrefix="cc1" Namespace="Aptify.Framework.Web.eBusiness" Assembly="AptifyEBusinessUser" %>
<%--<%@ Register Src="MeetingActionControl.ascx" TagName="MeetingActionControl" TagPrefix="uc1" %>--%>
<%@ Register TagPrefix="rad" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>
<link href="http://addtocalendar.com/atc/1.5/atc-style-blue.css" rel="stylesheet" type="text/css"><%-- line added by GM For Redmine #20655 --%>
<%--Anil B Issue 11155 and notification--%>
<script type="text/javascript">
    //function HideControl() {<%-- Susan Wong, #19497 --%>
    $(document).ready(function () {<%-- Susan Wong, #19497 --%>
    ...
    <%-- Susan Wong, #19497 END--%>
    //window.onload = function () {   //Susan Wong #19497
    //    document.body.onclick = HideNotification;   //Susan Wong #19497
    //}   //Susan Wong #19497
    <%-- Susan Wong, #19497 --%>
    //$(document).ready(function () {
    //    $('ul.notification-list-menu li').each(function () {
    //        var event_fulltext = $(this).text().trim();
    //        var event_name = event_fulltext.split(":")[0];
    //        var event_date = event_fulltext.split(":")[1];
    //        $(this).html('<span class="event_meeting_name">' + event_name + '</span>' + '<span class="event_meeting_date">' + event_date + '</span>');
    //    });
    //});

</script>
<%--below Script tag added by GM for Redmine #20655--%>
...
<%--End Script tag for Redmine #20655--%>
<div style="z-index: -1!Important;display:none!important" class="dvTopNotificationDiv"><%-- Susan Wong, #19497 --%>
    <ul class="ttw-notification-menu">
        <li class="notification-menu-item first-item" id="Li1">Meetings notification(s)
            <span class="notification-bubble" onclick="HideControl();" title="Notifications" style="background-color: rgb(245, 108, 126); display: inline;"></span>
            <span class="notification-bubble" title="Notifications">
...
<div class="content-container clearfix dvMyMeetingSetAlign" style="display:none"><%-- Susan Wong, #19497 --%>
    ...
    <div class="uiScrollableAreaTrack">
        <div>
            <div class="dvNotification">
                ...
                <asp:Label runat="server" ID="lblNotificationDivHeading" CssClass="lblNotificationHeading" Text="Your Registered Event" style="display:none"></asp:Label><%-- Susan Wong, #19497 --%>
                <div style="float: right; cursor: pointer;display:none"><%-- Susan Wong, #19497 --%>
        ...
        <div style="display: none"> <%-- Hide as part of #20443--%>
            <div class="dvNotification">
...
<script>
    //Susan Wong #20655 - add style to iCal button
    $(window).load(function () {
        if ($('.addtocalendar a.atcb-link').length) {
            $('.addtocalendar a.atcb-link').addClass("cai-btn cai-btn-aqua");
        }
    });
</script>
