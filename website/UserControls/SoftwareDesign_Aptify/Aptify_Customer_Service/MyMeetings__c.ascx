<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Customer_Service/MyMeetings__c.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.CustomerService.MyMeetings__c" %>
...
<div id="Open" runat="server" class="notification-list-wrapper dvNotificationPosition"
    ...
    <div class="uiScrollableAreaTrack">
        ...
        <div style="display: none"> <%--Hided as part of #20444 --%>
            <div class="dvNotification">
