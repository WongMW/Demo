<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Customer_Service/Profile.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.CustomerService.ProfileControl" %>
            ...
            <ContentTemplate>
                <div style="padding-top: 10px;">
                    ...
                    <div class="tablecontrolsfontLogin">
                        <asp:Button ID="btnSave" runat="server" Text="Save" OnClientClick="return ShowvalidationErrorMsg()" CssClass="submitBtn btn" />&nbsp;
                        <asp:Button ID="btnCancelpop" runat="server" Text="Cancel" CssClass="submitBtn btn" CausesValidation="false" />
                    </div>
                </div>
                <div>
                    <table>
