<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Customer_Service/SavedPaymentMethods.ascx.vb"
...
<rad:RadWindow ID="CreditcardWindow" runat="server" VisibleOnPageLoad="false" Modal="true"
    ...
    ForeColor="#bda797" VisibleStatusbar="false" Skin="Default" IconUrl="">
    <ContentTemplate>
        <table id="tblAddCard" runat="server" class="data-form">
            ...
            <tr>
                ...
                <td>
                    ...
                    <table>
                        <tr>
                            <td align="left">
                                <rad:RadBinaryImage ID="ImgVisa" runat="server" CssClass="creditcardImg" AutoAdjustImageControlSize="false"></rad:RadBinaryImage>
                            </td>
                            <td>
                                <rad:RadBinaryImage ID="ImgMasterCard" runat="server" CssClass="creditcardImg" AutoAdjustImageControlSize="false"></rad:RadBinaryImage>
                            </td>
                            <td>
                            ...
                            <td>
                                <rad:RadBinaryImage ID="ImgDiscover" runat="server" CssClass="creditcardImg" AutoAdjustImageControlSize="false"></rad:RadBinaryImage>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td align="right">
                    <em class="red">*</em> <b>Card Number: </b>
                </td>
                <td>
            ...
            <tr>
                <td align="right">
                    <%-- Anil B Issue 15408 on 08-04-2013
                        Change Header Text--%>
                    <em class="red">*</em> <b>Card Nickname: </b>
                </td>
                <td>
            ...
            <tr>
                <td colspan="2">&nbsp;<asp:Label ID="lblError" ForeColor="Red" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
