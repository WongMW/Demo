<%@ Control Language="vb" AutoEventWireup="false" Inherits="Aptify.Framework.Web.eBusiness.BrowseControl" CodeFile="~/UserControls/Aptify_Directories/Browse.ascx.vb" %>
