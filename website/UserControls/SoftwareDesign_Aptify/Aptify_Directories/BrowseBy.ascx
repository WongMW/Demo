<%@ Control Language="vb" AutoEventWireup="false" Inherits="Aptify.Framework.Web.eBusiness.Directories.BrowseByControl" CodeFile="~/UserControls/Aptify_Directories/BrowseBy.ascx.vb" debug= "true" %>
