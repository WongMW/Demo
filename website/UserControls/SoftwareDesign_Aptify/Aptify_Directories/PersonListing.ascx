<%@ Control Language="vb" AutoEventWireup="false" Inherits="Aptify.Framework.Web.eBusiness.PersonListing" CodeFile="~/UserControls/Aptify_Directories/PersonListing.ascx.vb"  %>
