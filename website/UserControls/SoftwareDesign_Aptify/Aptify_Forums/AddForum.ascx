 ...
 <%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Forums/AddForum.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.Forums.AddForumControl" %> 
