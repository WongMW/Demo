<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Forums/DisplayMessage.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.Forums.DisplayMessageControl" %>
