<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Forums/ForumSubscription.ascx.vb"
...
<div class="content-container clearfix">
    ...
    <div>
        <asp:UpdatePanel ID="updPanelGrid" runat="server" UpdateMode="Always">
            <ContentTemplate>
                <asp:Button CssClass="submitBtn" ID="cmdSave" runat="server" Text="Save Changes"></asp:Button>
                ...
                <rad:RadGrid ID="grdForumSubscriptions" runat="server" AutoGenerateColumns="False" DataKeyNames="Name"
                    ...
                    <%--Sandeep issue 14671 2/27/13 Allow Paging true--%>
