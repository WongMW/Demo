 ...
 <%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Forums/ForumTitle.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.Forums.ForumTitleControl" %> 
