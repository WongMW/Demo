 ...
 <%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Forums/ForumsHome.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.Forums.ForumsHome" %> 
