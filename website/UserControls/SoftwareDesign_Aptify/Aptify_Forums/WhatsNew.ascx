<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Forums/WhatsNew.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.Forums.WhatsNewControl" %>
                    ...
                    <tr>
                        <td>
                            <asp:Panel ID="PnlPosting" runat="server">
                                ...
                                <%--Nalini Issue 12734--%>
                                <asp:Button ID="cmdRefresh" runat="server" Text="Refresh" CssClass="submitBtn"></asp:Button>
                            </asp:Panel>
                        </td>
                    </tr>
                    <tr>
