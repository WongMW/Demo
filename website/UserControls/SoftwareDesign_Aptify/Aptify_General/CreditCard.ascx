<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_General/CreditCard.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.CreditCard"
    Debug="true" %>
...
<table id="Table1" runat="server" class="data-form">
    <tr>
        <td style="width: 117px; padding-left: 5px;" align="right">
            <b>
                <asp:Label ID="lblBillMelater" class="billing-label" runat="server"></asp:Label></b>
        </td>
        <td  class="tdCreditCardBillMeLater">
           <asp:CheckBox ID="chkBillMeLater" runat="server" Text="" CssClass="billing-label" TextAlign="Left" OnCheckedChanged="chkBillMeLater_CheckedChanged" AutoPostBack="true"  />
        </td>
    </tr>
</table>
    <%--Anil B Issue 10254 on 07-03-2013
    Set the design thrugh css--%>
        <table id="tblMain" runat="server" class="data-form credit-payment-options">
            <tr runat="server" id="trSMP">
                <td style="width: 200px; padding-left: 4px;" align="right">
                    <b>
            ...
            <tr id="trExpiryDate" runat="server">
                ...
                <td>
                    <asp:DropDownList ID="dropdownMonth" runat="server" Width="100%">
            ...
            <tr align="right"  style="float:right;">
                <td>
