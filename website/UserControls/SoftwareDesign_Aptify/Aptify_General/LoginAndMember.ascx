<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_General/LoginAndMember.ascx.vb"
    Inherits="Aptify.Framework.Web.eBusiness.LoginAndMember" %>
<%@ Register TagPrefix="cc1" Namespace="Aptify.Framework.Web.eBusiness" Assembly="AptifyEBusinessUser" %>
<%@ Register Src="~/UserControls/SoftwareDesign_Aptify/Aptify_General/BecomeMemberControl.ascx" TagName="BecomeMemberControl"
    TagPrefix="uc1" %>
