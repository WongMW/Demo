<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_General/NameAddressBlock.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.NameAddressBlock" %>
...
<asp:label Visible="false" id="lblState" runat="server">State</asp:label>
