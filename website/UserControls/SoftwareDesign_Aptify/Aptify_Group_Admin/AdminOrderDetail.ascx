<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Group_Admin/AdminOrderDetail.ascx.vb"
    ...
    <asp:UpdatePanel ID="UpdatepnlorderDetail" runat="server">
        <ContentTemplate>
            <table id="tblmember" runat="server" width="100%" class="data-form">
                <tr>
                    <td runat="server" style="font-weight: bold; font-size: 13px; height: 30px">Pay Open Invoices for My Company
                    </td>
                </tr>
                <tr>
                    <td>
                            ...
                            <MasterTableView AllowFilteringByColumn="true">
                                <Columns>
                                    ...
                                    <rad:GridTemplateColumn AllowFiltering="false">
                                        ...
                                        <HeaderTemplate>
                                            <asp:CheckBox ID="chkAllMakePayment" Width="30px" runat="server" OnCheckedChanged="ToggleSelectedState" CssClass="chkAllMakePayment chkAllCheckBoxes" AutoPostBack="True" />
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                    ...
                                    <rad:GridTemplateColumn HeaderText="Name" DataField="Name" SortExpression="Name"
                                        ...
                                        <ItemStyle HorizontalAlign="Center" CssClass="LeftAlign gridAlign" Width="120px"></ItemStyle>
                                        <ItemTemplate>
        ...
        <tr>
            <td valign="top" align="left" style="padding-left: 8px">
                ...
                <asp:Button CssClass="submitBtn" ID="cmdMakePayment" TabIndex="1" runat="server"
                    Height="26px" Text="Make Payment" UseSubmitBehavior="false" OnClientClick="validatePage();"></asp:Button>
            </td>
        </tr>
    </table>
</div>
