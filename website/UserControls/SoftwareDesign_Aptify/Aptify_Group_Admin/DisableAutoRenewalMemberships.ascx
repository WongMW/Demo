<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Group_Admin/DisableAutoRenewalMemberships.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.DisableAutoRenewalMemberships" %>
