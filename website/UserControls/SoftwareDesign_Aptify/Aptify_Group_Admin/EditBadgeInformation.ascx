<%@ Control Language="VB" AutoEventWireup="true" CodeFile="~/UserControls/Aptify_Group_Admin/EditBadgeInformation.ascx.vb"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                ...
                                                                AlternateText='<%#Eval("Name", "Photoof {0}") %>' />--%>
                                                            </div>
                                                        </td>
                                                        <td>
                                    ...
                                    <ContentTemplate>
                                        <div style="background-color: #f4f3f1; padding: 5px;">
                                            <table cellpadding="0" cellspacing="0" style="background-color: #f4f3f1;">
                                                <tr>
                                                    <td class="lblBadgeInformation" colspan="3"></td>
                                                    <%--  <td></td>--%>
                                                </tr>
                                                <tr style="padding-bottom: 5px;">
                                                    ...
                                                    <td style="padding-bottom: 5px;" class="width: 268px">&nbsp;<asp:TextBox ID="txtBadgeName" Width="180px" TabIndex="1" runat="server"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr style="padding-bottom: 5px;">
                                                    <td style="padding-bottom: 5px;" class="rightAlign">
                                                    ...
                                                    <td style="padding-bottom: 5px;" class="width: 268px">&nbsp;<asp:TextBox ID="txtBadgeTitle" runat="server" Width="180px" TabIndex="2"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr style="padding-bottom: 5px;">
                                                    <td style="padding-bottom: 5px;" class="rightAlign">
                                                    ...
                                                    <td style="padding-bottom: 5px;" class="width: 268px">&nbsp;<asp:TextBox ID="txtBadgeCompany" runat="server" Width="180px" TabIndex="3"></asp:TextBox>
