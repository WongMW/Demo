<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Group_Admin/UpcomingEventsRegistrationChart.ascx.vb"
...
<div class="blue-content-block full-width">
    <div class="content-block-title">
        <div class="ChartTitle">Upcoming Events - Registration Summary</div>
    </div>

    <div class="content-block-content">
        <div>
            <div class="select-group">
                <asp:DropDownList ID="cmbDate" CssClass="txtBoxEditProfileForDropdown" runat="server" AutoPostBack="True">
                </asp:DropDownList>
        ...
        <rad:RadChart ID="radChart" runat="server" DefaultType="StackedBar" PlotArea-EmptySeriesMessage-TextBlock-Text="No Upcoming Events"
            Skin="Telerik" PlotArea-YAxis-AxisMode="Extended">
