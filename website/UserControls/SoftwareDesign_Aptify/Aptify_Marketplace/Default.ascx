<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Marketplace/Default.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.MarketPlace._Default" %>
