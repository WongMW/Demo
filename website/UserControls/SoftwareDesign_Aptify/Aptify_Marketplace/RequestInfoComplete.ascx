<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Marketplace/RequestInfoComplete.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.MarketPlace.RequestInfoComplete" %>
