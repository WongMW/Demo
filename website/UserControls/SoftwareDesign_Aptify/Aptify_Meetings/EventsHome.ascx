<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Meetings/EventsHome.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.EventsHome" %>
...
<div class="Events" style="padding: 15px">
    ...
    <div class="EventsFilter" style="width: 100%; margin-bottom: 0.5em; vertical-align: middle; height: 30px;">
        <span class="EventCategory" style="margin-right: 1em;">Event Category:&nbsp;
            <asp:DropDownList runat="server" ID="cmbCategory" AutoPostBack="true" CssClass="cmbEventCategory">
            </asp:DropDownList>
        </span>
        <span class="EventType" style="margin-right: 1em;">Event Type:&nbsp;
