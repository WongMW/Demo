<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Meetings/MeetingEvents.ascx.vb"
            ...
            <div id="DetailDiv" style="font-size: small; float: left; width: 99%;">
                <table id="tblDetail" runat="server" style="font-size: 12px">
                    <tr runat="server" visible="false" id="trSessionParent">
                        <td style="font-weight: bold">Part of:
                        </td>
                        <td>
                    ...
                    <tr>
                        <td style="font-weight: bold; width: 20%;">Date:
                        </td>
                        <td style="width: 75%;">
                            <%--Dilip Issue 13144 Remove folder Aptify_UC_Img from image path--%>
                            <asp:Label ID="lblVenue" runat="server">Venue:</asp:Label>&nbsp;&nbsp;<asp:Image runat="server" ID="VenueDirection" ImageUrl="~/Images/get-diRegistration Fee" />: </td>
                        <td>
                            <asp:Label ID="lblTotalPrice" runat="server"></asp:Label></td>
                    </tr>
                </table>
            </div>
            <div id="DescriptionDiv" style="font-size: 11px; font-weight: normal; float: left; width: 100%; margin-top: 1.5em; margin-bottom: 1.5em; text-align: justify;">
                                        ...
                                        <asp:Label runat="server" ID="lblTravel" Visible="false"></asp:Label><asp:Repeater
                                            ...
                                            <ItemTemplate>
                                                <table width="98%" style="font-size: 11px; margin: 4px;">
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <asp:Label ID="lblHotelName" runat="server"></asp:Label></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">
                                                            <asp:Label ID="lblGroupOffer" runat="server"></asp:Label></td>
                                                    </tr>
                                                    <tr>
