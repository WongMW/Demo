<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Meetings/MeetingsHome.ascx.vb"
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div id="tblMain" runat="server" class="data-form">
                <span class="label-title">Meeting category:</span>
                ...
                <asp:HyperLink ID="MeetingsCalendarPage" runat="server" Text="Calendar view" class="stand-alone-link" />
                    ...
                    <rad:RadGrid ID="grdMeetings" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                        ...
                        <MasterTableView DataKeyNames="ID" AllowFilteringByColumn="True" AllowNaturalSort="false"
                            ...
                            <DetailTables>
                                ...
                                <telerik:GridTableView DataKeyNames="ID" Name="ChildGrid" runat="server" AllowFilteringByColumn="false"
