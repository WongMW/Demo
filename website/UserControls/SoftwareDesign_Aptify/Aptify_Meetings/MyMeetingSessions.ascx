<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Meetings/MyMeetingSessions.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.Meetings.MyMeetingSessions" %>
