<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Product_Catalog/AdminPaymentSummary.ascx.vb"
...
<br />
<asp:Button CssClass="submitBtn" ID="cmdback" TabIndex="1" runat="server" Text="Back"></asp:Button>
