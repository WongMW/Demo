<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Product_Catalog/BillingControl.ascx.vb"
...
<table>
    <tr>
        <td valign="top" align="left" colspan="2">
            ...
            <asp:Button CssClass="submitBtn" ID="cmdPlaceOrder" TabIndex="1" runat="server" Height="26px" Text="Complete Order">
            </asp:Button>
        </td>
    </tr>
</table>
