<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Product_Catalog/OrderSummary.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.ProductCatalog.OrderSummaryControl"%>
