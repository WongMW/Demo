<%@ Control Language="VB" AutoEventWireup="false" CodeFile="~/UserControls/Aptify_Product_Catalog/ProductCategory.ascx.vb" Inherits="Aptify.Framework.Web.eBusiness.ProductCatalog.ProductCategoryControl" %>
...
<div class="content-container clearfix">
    <cc2:ProductCategoryLinkString id="ProductCategoryLinkString1" CssClass="category-menu" runat="server" HyperlinkRootCategory="True" RootCategoryText="All Categories"  Font-Bold="true" ></cc2:ProductCategoryLinkString>
