<%@ Control Language="C#" AutoEventWireup="true" CodeFile="~/UserControls/CAI_Custom_Controls/EventCalendar__c.ascx.cs" Inherits="UserControls_CAI_Custom_Controls_EventCalendar__c" %>
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="responsive-calendar col-md-8 col-md-offset-2">
                    <div class="controls">
                        <a class="pull-left">
                            <button id="cal-prev-btn" type="button" class="submitBtn col-md-12">Prev</button>
                        </a>
                        ...
                        <a class="pull-right">
                            <button id="cal-next-btn" type="button" class="submitBtn col-md-12">Next</button>
                        </a>
                    </div>
                    <hr />
            ...
            <div class="row">
                ...
                <div class="col-md-12 cai-marg-top-10">
                    <button id="showNextEvents" type="button" class="submitBtn col-xs-12 col-md-8 col-md-offset-2">Show next 7 days</button>
                </div>
            </div>
        </div>
    </div>
