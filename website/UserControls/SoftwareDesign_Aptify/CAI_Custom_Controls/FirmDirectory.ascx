<%@ Control Language="C#" AutoEventWireup="true" CodeFile="~/UserControls/CAI_Custom_Controls/FirmDirectory.ascx.cs" Inherits="UserControls_CAI_Custom_Controls_FirmDirectory" %>
                    ...
                    <div class="collapse navbar-collapse" id="directory-filter">
                        <ul class="nav" role="menu">
                            <li class="row cai-drodown-form">
                                <label class="col-xs-9" for="contentPlaceholder_C001_chkBoxIncFirms">Include Firms</label>
                                <span class="col-xs-3"><asp:CheckBox class="pull-right" ID="chkBoxIncFirms" Checked="true" runat="server" /></span>
                            </li>
                            <li class="row cai-drodown-form">
                                <label class="col-xs-9" for="contentPlaceholder_C001_chkBoxIncMembers">Include Members</label>
                            ...
                            <li class="row button-group">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Specialism</a>
                            ...
                            <li class="row button-group">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Licence</a>
                                <ul class="dropdown-menu col-xs-12">
                                    <li>
                                        <div class="row">
            ...
            <!--<form role="search">-->
                ...
                <div id="filters">
                    ...
                    <div class="form-group btn-group" role="group" aria-label="Location search filter">
                        <button type="button" class="submitBtn">Ireland (interactive map)</button>
                        <button type="button" class="submitBtn">Worldwide (interactive map)</button>
                        <button type="button" class="submitBtn">Search by text</button>
                    </div>
                    <div class="form-group">
