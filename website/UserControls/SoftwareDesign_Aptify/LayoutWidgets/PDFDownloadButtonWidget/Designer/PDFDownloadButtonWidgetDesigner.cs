...
namespace SitefinityWebApp.UserControls.SoftwareDesign_Aptify.LayoutWidgets.PDFDownloadButtonWidget.Designer
{
    /// <summary>
    /// Represents a designer for the <typeparamref name="SitefinityWebApp.UserControls.SoftwareDesign_Aptify.LayoutWidgets.PDFDownloadButtonWidget.PDFDownloadButtonWidget"/> widget
    /// </summary>
    public class PDFDownloadButtonWidgetDesigner : ControlDesignerBase
    {
        #region Properties
        /// <summary>
        ...
        public override string LayoutTemplatePath
        {
            get
            {
                if (string.IsNullOrEmpty(base.LayoutTemplatePath))
                    return PDFDownloadButtonWidgetDesigner.layoutTemplatePath;
        ...
        /// <summary>
        /// Gets the control that is bound to the CourseName property
        /// </summary>
        protected virtual Control CourseName
        {
            get
            {
                return this.Container.GetControl<Control>("CourseName", true);
            }
        }
        /// <summary>
        /// Gets the control that is bound to the InteractionType property
        /// </summary>
        protected virtual Control InteractionType
        {
            get
            {
                return this.Container.GetControl<Control>("InteractionType", true);
            }
        }
        /// <summary>
        ...
        public override System.Collections.Generic.IEnumerable<System.Web.UI.ScriptDescriptor> GetScriptDescriptors()
        {
            ...
            descriptor.AddElementProperty("courseName", this.CourseName.ClientID);
            descriptor.AddElementProperty("interactionType", this.InteractionType.ClientID);
        ...
        public override System.Collections.Generic.IEnumerable<System.Web.UI.ScriptReference> GetScriptReferences()
        {
            ...
            scripts.Add(new ScriptReference(PDFDownloadButtonWidgetDesigner.scriptReference));
            return scripts;
        }
        #endregion

        #region Private members & constants
        public static readonly string layoutTemplatePath = "~/UserControls/SoftwareDesign_Aptify/LayoutWidgets/PDFDownloadButtonWidget/Designer/PDFDownloadButtonWidgetDesigner.ascx";
        public const string scriptReference = "~/UserControls/SoftwareDesign_Aptify/LayoutWidgets/PDFDownloadButtonWidget/Designer/PDFDownloadButtonWidgetDesigner.js";
