Type.registerNamespace("SitefinityWebApp.UserControls.SoftwareDesign_Aptify.LayoutWidgets.QuoteWidget.Designer");

SitefinityWebApp.UserControls.SoftwareDesign_Aptify.LayoutWidgets.QuoteWidget.Designer.QuoteWidgetDesigner = function (element) {
    ...
    SitefinityWebApp.UserControls.SoftwareDesign_Aptify.LayoutWidgets.QuoteWidget.Designer.QuoteWidgetDesigner.initializeBase(this, [element]);
}

SitefinityWebApp.UserControls.SoftwareDesign_Aptify.LayoutWidgets.QuoteWidget.Designer.QuoteWidgetDesigner.prototype = {
    /* --------------------------------- set up and tear down --------------------------------- */
    initialize: function () {
        /* Here you can attach to events or do other initialization */
        SitefinityWebApp.UserControls.SoftwareDesign_Aptify.LayoutWidgets.QuoteWidget.Designer.QuoteWidgetDesigner.callBaseMethod(this, 'initialize');
    ...
    dispose: function () {
        ...
        SitefinityWebApp.UserControls.SoftwareDesign_Aptify.LayoutWidgets.QuoteWidget.Designer.QuoteWidgetDesigner.callBaseMethod(this, 'dispose');
    ...
    refreshUI: function () {
        ...
        /* RefreshUI Message */
        jQuery(this.get_author()).val(controlData.Author);
        jQuery(this.get_quote()).val(controlData.Quote);
    ...
    applyChanges: function () {
        ...
        controlData.Author = jQuery(this.get_author()).val();
        controlData.Quote = jQuery(this.get_quote()).val();
    ...
    /* Message properties */
    get_author: function () { return this._author; }, 
    set_author: function (value) { this._author = value; },
    get_quote: function () { return this._quote; }, 
    set_quote: function (value) { this._quote = value; },
...
SitefinityWebApp.UserControls.SoftwareDesign_Aptify.LayoutWidgets.QuoteWidget.Designer.QuoteWidgetDesigner.registerClass('SitefinityWebApp.UserControls.SoftwareDesign_Aptify.LayoutWidgets.QuoteWidget.Designer.QuoteWidgetDesigner', Telerik.Sitefinity.Web.UI.ControlDesign.ControlDesignerBase);
