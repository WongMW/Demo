        ...
        <li class="sfFormCtrl">
            ...
            <div id="ImagesSelector">
                <div class="left">
                    <sf:FlatSelector ID="ItemSelector" runat="server" ItemType="Telerik.Sitefinity.Libraries.Model.Image"
                        ...
                        <DataMembers>
                            <sf:DataMemberInfo runat="server" Name="Image" IsExtendedSearchField="false" HeaderText='Image'>
                                <div>
                                    <img alt="Alternate Text" class="tmb" />
                            ...
                            <sf:DataMemberInfo runat="server" Name="Subtitle" IsExtendedSearchField="False" HeaderText='Subtitle'>
                                <strong>{{AlternativeText}}</strong>
                            </sf:DataMemberInfo>
                        </DataMembers>
                    </sf:FlatSelector>
                </div>
            ...
            <script id="ul-template-ImagesSelector" type="text/x-kendo-template">
                <li>
                    ...
                    <asp:Label runat="server" CssClass="sfTxtLbl">Title</asp:Label>
                    <span data-bind="text: Title"> </span>

                    <asp:Label runat="server" CssClass="sfTxtLbl">Subtitle</asp:Label>
                    <span data-bind="text: AlternativeText"> </span>

                    <asp:Label runat="server"  CssClass="sfTxtLbl">PageURL</asp:Label>
