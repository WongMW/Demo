<%@ Control Language="vb" AutoEventWireup="false" Inherits="Aptify.Framework.Web.eBusiness.Generated.ContactFormLecturerOnlineResources__caiClass" CodeFile="ContactFormLecturerOnlineResources__cai.ascx.vb" %>
...
<%--      <tr>
           <td class="LeftColumn"><span class="label-title">Mobile
               <asp:RegularExpressionValidator ID="regexPhoneValid2" runat="server" ControlToValidate="txtMobile" ForeColor="Red" ValidationGroup="FormValid" ValidationExpression="^\(?\+?[\d\(\-\s\)]+$" 
                   style="float:right;"></asp:RegularExpressionValidator></span>
           </td>
           <td class="RightColumn">
               <asp:TextBox id="txtMobile" runat="server" AptifyDataField="Mobile" Width="100%" ValidationGroup="FormValid" Placeholder="Your mobile number" />
           </td>
      </tr>--%>
      <tr>
      ...
      <tr>
           ...
           <td class="RightColumn">
               <asp:TextBox id="txtYears" runat="server" AptifyDataField="Years" Width="100%" CssClass="textbox" ValidationGroup="FormValid" Placeholder="Level(s) you teach at e.g. BA/MA, etc." />
           </td>
      </tr>
      <tr>
      ...
      <tr>
           <td class="LeftColumn"><div class="required">Chartered Accountants Ireland textbook(s) adopted (required)
           ...
           <td class="RightColumn">
               <asp:TextBox id="txtTextbooksRequested" runat="server" AptifyDataField="TextbooksRequested" Width="100%" CssClass="textbox" TextMode="MultiLine" Height="100px" ValidationGroup="FormValid" Placeholder="The textbooks you have adopted" />
           </td>
      </tr>
<%--      <tr>
           <td class="LeftColumn"><div class="required">Have you placed an order yet for your title? (required)
               <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="cmbOrderPlaced" ErrorMessage="This field is required" ForeColor="Red" 
                    Display="Dynamic" ValidationGroup="FormValid" style="float:right"></asp:RequiredFieldValidator>
               </div></td>
           <td class="RightColumn">
               <asp:DropDownList id="cmbOrderPlaced" runat="server" AptifyDataField="OrderPlaced" >
      ...
      <tr>
           <td class="LeftColumn"><span class="label-title">Is there a bookshop at your university/institution?</span></td>
           <td class="RightColumn">
               <asp:DropDownList id="cmbBookshop" runat="server" AptifyDataField="Bookshop" CssClass="textbox" >
                   <asp:ListItem>No</asp:ListItem>
                   <asp:ListItem>Yes</asp:ListItem>
               </asp:DropDownList>
           </td>
      ...
      <tr>
           ...
           <td class="RightColumn">
               <asp:TextBox id="txtMemberNumber" runat="server" AptifyDataField="MemberNumber" Width="100%" Placeholder="Your membership number" CssClass="textbox" />
           </td>
      </tr>
      <tr>
