...
Namespace Aptify.Framework.Web.eBusiness.Generated
   ...
   ''' <summary>
   ''' Generated ASP.NET User Control for the ContactFormLecturerOnlineResources__cai entity.
   ''' </summary>
   ''' <remarks></remarks>
   Partial Class ContactFormLecturerOnlineResources__caiClass
       Inherits Aptify.Framework.Web.eBusiness.BaseUserControlAdvanced

       Protected Const ATTRIBUTE_CONTORL_DEFAULT_NAME As String = "ContactFormLecturerOnlineResources__caiPage"
       ...
       Protected Overridable Sub LoadRecord()
           Try
               If Me.SetControlRecordIDFromParam() Then
                   LoadDataFromGE(Me.AptifyApplication.GetEntityObject("ContactFormLecturerOnlineResources__cai", ControlRecordID))
               Else
                   LoadDataFromGE(Me.AptifyApplication.GetEntityObject("ContactFormLecturerOnlineResources__cai", -1))
               End If
       ...
       Protected Overridable Sub SaveRecord(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
           ...
           Try
                If Me.ControlRecordID > 0 Then
                    oGE = AptifyApplication.GetEntityObject("ContactFormLecturerOnlineResources__cai", Me.ControlRecordID)
                Else
                    oGE = AptifyApplication.GetEntityObject("ContactFormLecturerOnlineResources__cai", -1)
                End If
