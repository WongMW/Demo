<%@ Control Language="vb" AutoEventWireup="false" Inherits="Aptify.Framework.Web.eBusiness.Generated.ContactForm_AccIre_Opt_Out_Queries__caiClass" CodeFile="ContactForm_AccIre_Opt_Out_Queries__cai.ascx.vb" %>
      ...
      <tr>
           <td class="LeftColumn">
               <div class="required">
                   ...
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator0" runat="server" ControlToValidate="txtMembership_Student_Number" ErrorMessage="Membership/student number is required" ForeColor="Red" Display="Dynamic" ValidationGroup="FormValid" style="float: right;"></asp:RequiredFieldValidator>
               </div>
           </td>
           <td class="RightColumn">
               <asp:TextBox id="txtMembership_Student_Number" runat="server" AptifyDataField="Membership_Student_Number" Width="100%" ValidationGroup="FormValid" Placeholder="Enter your membership/student number e.g. 0123456"/>
