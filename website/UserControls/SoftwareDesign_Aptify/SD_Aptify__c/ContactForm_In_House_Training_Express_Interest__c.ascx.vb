...
Namespace Aptify.Framework.Web.eBusiness.Generated
   ...
   ''' <summary>
   ''' Generated ASP.NET User Control for the ContactForm_In_House_Training_Express_Interest__c entity.
   ''' </summary>
   ''' <remarks></remarks>
   Partial Class ContactForm_In_House_Training_Express_Interest__cClass
       Inherits Aptify.Framework.Web.eBusiness.BaseUserControlAdvanced

       Protected Const ATTRIBUTE_CONTORL_DEFAULT_NAME As String = "ContactForm_In_House_Training_Express_Interest__cPage"
       ...
       Protected Overridable Sub LoadRecord()
           Try
               If Me.SetControlRecordIDFromParam() Then
                   LoadDataFromGE(Me.AptifyApplication.GetEntityObject("ContactForm_In_House_Training_Express_Interest__c", ControlRecordID))
               Else
                   LoadDataFromGE(Me.AptifyApplication.GetEntityObject("ContactForm_In_House_Training_Express_Interest__c", -1))
               End If
       ...
       Protected Overridable Sub SaveRecord(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
           ...
           Try
               If Me.ControlRecordID > 0 Then
                   oGE = AptifyApplication.GetEntityObject("ContactForm_In_House_Training_Express_Interest__c", Me.ControlRecordID)
               Else
                   oGE = AptifyApplication.GetEntityObject("ContactForm_In_House_Training_Express_Interest__c", -1)
               End If
