...
Namespace Aptify.Framework.Web.eBusiness.Generated
   ...
   ''' <summary>
   ''' Generated ASP.NET User Control for the ContactForm_Technical_Queries__cai entity.
   ''' </summary>
   ''' <remarks></remarks>
   Partial Class ContactForm_Technical_Queries__caiClass
       Inherits Aptify.Framework.Web.eBusiness.BaseUserControlAdvanced

       Protected Const ATTRIBUTE_CONTORL_DEFAULT_NAME As String = "ContactForm_Technical_Queries__caiPage"
        ...
        Protected Overridable Sub LoadRecord()
            Try
                If Me.SetControlRecordIDFromParam() Then
                    LoadDataFromGE(Me.AptifyApplication.GetEntityObject("ContactForm_Technical_Queries__cai", ControlRecordID))
                Else
                    LoadDataFromGE(Me.AptifyApplication.GetEntityObject("ContactForm_Technical_Queries__cai", -1))
                End If
        ...
        Protected Overridable Sub SaveRecord(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
            ...
            Try
                If Me.ControlRecordID > 0 Then
                    oGE = AptifyApplication.GetEntityObject("ContactForm_Technical_Queries__cai", Me.ControlRecordID)
                Else
                    oGE = AptifyApplication.GetEntityObject("ContactForm_Technical_Queries__cai", -1)
                End If
